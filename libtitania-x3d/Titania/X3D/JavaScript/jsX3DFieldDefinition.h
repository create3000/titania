...
#ifndef __TITANIA_X3D_JAVA_SCRIPT_JS_X3DFIELD_DEFINITION_H__
#define __TITANIA_X3D_JAVA_SCRIPT_JS_X3DFIELD_DEFINITION_H__
	...
	public jsX3DObject
{
	...
	static JSBool getAccessType (JSContext *, JSObject *, jsval, jsval*);
	static JSBool getDataType (JSContext *, JSObject *, jsval, jsval*);
