...
template <>
JSClass jsX3DConstArray <jsX3DExternProtoDeclaration, X3D::ExternProtoArray>::static_class = {
...
template class jsX3DConstArray <jsX3DExternProtoDeclaration, X3D::ExternProtoArray>;
