...
JSClass ComponentInfo::static_class = {
...
JSPropertySpec ComponentInfo::properties [ ] = {
...
JSObject*
ComponentInfo::init (JSContext* const cx, JSObject* const global, JSObject* const parent)
{
...
JSBool
ComponentInfo::create (JSContext* const cx, const X3D::ComponentInfoPtr & componentInfo, jsval* const vp)
{
...
JSBool
ComponentInfo::name (JSContext* cx, JSObject* obj, jsid id, jsval* vp)
{
	try
	{
		const auto & componentInfo = *getThis <ComponentInfo> (cx, obj);
...
JSBool
ComponentInfo::level (JSContext* cx, JSObject* obj, jsid id, jsval* vp)
{
	try
	{
		const auto & componentInfo = *getThis <ComponentInfo> (cx, obj);
...
JSBool
ComponentInfo::title (JSContext* cx, JSObject* obj, jsid id, jsval* vp)
{
	try
	{
		const auto & componentInfo = *getThis <ComponentInfo> (cx, obj);
...
JSBool
ComponentInfo::providerUrl (JSContext* cx, JSObject* obj, jsid id, jsval* vp)
{
	try
	{
		const auto & componentInfo = *getThis <ComponentInfo> (cx, obj);
...
void
ComponentInfo::finalize (JSContext* cx, JSObject* obj)
{
