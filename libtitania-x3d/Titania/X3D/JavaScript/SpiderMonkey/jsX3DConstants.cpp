...
JSPropertySpec jsX3DConstants::properties [ ] = {
	...
	{ "INITIALIZED_EVENT", _INITIALIZED_EVENT, JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, INITIALIZED_EVENT, NULL },
	{ "SHUTDOWN_EVENT",    _SHUTDOWN_EVENT,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SHUTDOWN_EVENT,    NULL },

	// Error types

	{ "CONNECTION_ERROR",  _CONNECTION_ERROR,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, CONNECTION_ERROR,  NULL },
	{ "INITIALIZED_ERROR", _INITIALIZED_ERROR, JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, INITIALIZED_ERROR, NULL },

	// Load state

	{ "NOT_STARTED_STATE", _NOT_STARTED_STATE, JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, NOT_STARTED_STATE, NULL },
	{ "IN_PROGRESS_STATE", _IN_PROGRESS_STATE, JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, IN_PROGRESS_STATE, NULL },
	{ "COMPLETE_STATE",    _COMPLETE_STATE,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, COMPLETE_STATE,    NULL },
	{ "FAILED_STATE",      _FAILED_STATE,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, FAILED_STATE,      NULL },

	// Access types

	{ "initializeOnly", INITIALIZE_ONLY, JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, initializeOnly, NULL },
	{ "inputOnly",      INPUT_ONLY,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, inputOnly,      NULL },
	{ "outputOnly",     OUTPUT_ONLY,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, outputOnly,     NULL },
	{ "inputOutput",    INPUT_OUTPUT,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, inputOutput,    NULL },

	// Field types

	{ "SFBool",      SFBOOL,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFBool,      NULL },
	{ "SFColor",     SFCOLOR,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFColor,     NULL },
	{ "SFColorRGBA", SFCOLORRGBA, JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFColorRGBA, NULL },
	{ "SFDouble",    SFDOUBLE,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFDouble,    NULL },
	{ "SFFloat",     SFFLOAT,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFFloat,     NULL },
	{ "SFInt32",     SFINT32,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFInt32,     NULL },
	{ "SFImage",     SFIMAGE,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFImage,     NULL },
	{ "SFMatrix3d",  SFMATRIX3D,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFMatrix3d,  NULL },
	{ "SFMatrix3f",  SFMATRIX3F,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFMatrix3f,  NULL },
	{ "SFMatrix4d",  SFMATRIX4D,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFMatrix4d,  NULL },
	{ "SFMatrix4f",  SFMATRIX4F,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFMatrix4f,  NULL },
	{ "SFNode",      SFNODE,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFNode,      NULL },
	{ "SFRotation",  SFROTATION,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFRotation,  NULL },
	{ "SFString",    SFSTRING,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFString,    NULL },
	{ "SFTime",      SFTIME,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFTime,      NULL },
	{ "SFVec2d",     SFVEC2D,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFVec2d,     NULL },
	{ "SFVec2f",     SFVEC2F,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFVec2f,     NULL },
	{ "SFVec3d",     SFVEC3D,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, SFVec3d,     NULL },
	...
	{ "MFDouble",    MFDOUBLE,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFDouble,    NULL },
	{ "MFFloat",     MFFLOAT,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFFloat,     NULL },
	{ "MFImage",     MFIMAGE,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFImage,     NULL },
	{ "MFInt32",     MFINT32,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFInt32,     NULL },
	{ "MFMatrix3d",  MFMATRIX3D,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFMatrix3d,  NULL },
	{ "MFMatrix3f",  MFMATRIX3F,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFMatrix3f,  NULL },
	{ "MFMatrix4d",  MFMATRIX4D,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFMatrix4d,  NULL },
	{ "MFMatrix4f",  MFMATRIX4F,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFMatrix4f,  NULL },
	{ "MFNode",      MFNODE,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFNode,      NULL },
	{ "MFRotation",  MFROTATION,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFRotation,  NULL },
	{ "MFString",    MFSTRING,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFString,    NULL },
	{ "MFTime",      MFTIME,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFTime,      NULL },
	{ "MFVec2d",     MFVEC2D,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFVec2d,     NULL },
	{ "MFVec2f",     MFVEC2F,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFVec2f,     NULL },
	{ "MFVec3d",     MFVEC3D,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFVec3d,     NULL },
	{ "MFVec3f",     MFVEC3F,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFVec3f,     NULL },
	{ "MFVec4d",     MFVEC4D,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFVec4d,     NULL },
	{ "MFVec4f",     MFVEC4F,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, MFVec4f,     NULL },

	// Node types

	{ "X3DAppearanceChildNode",       X3D_APPEARANCECHILD_NODE,       JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DAppearanceChildNode,       NULL },
	{ "X3DAppearanceNode",            X3D_APPEARANCE_NODE,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DAppearanceNode,            NULL },
	{ "X3DBackgroundNode",            X3D_BACKGROUND_NODE,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DBackgroundNode,            NULL },
	{ "X3DBindableNode",              X3D_BINDABLE_NODE,              JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DBindableNode,              NULL },
	{ "X3DBoundedObject",             X3D_BOUNDED_OBJECT,             JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DBoundedObject,             NULL },
	{ "X3DChaserNode",                X3D_CHASER_NODE,                JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DChaserNode,                NULL },
	{ "X3DChildNode",                 X3D_CHILD_NODE,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DChildNode,                 NULL },
	{ "X3DColorNode",                 X3D_COLOR_NODE,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DColorNode,                 NULL },
	{ "X3DComposedGeometryNode",      X3D_COMPOSEDGEOMETRY_NODE,      JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DComposedGeometryNode,      NULL },
	{ "X3DCoordinateNode",            X3D_COORDINATE_NODE,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DCoordinateNode,            NULL },
	{ "X3DDamperNode",                X3D_DAMPER_NODE,                JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DDamperNode,                NULL },
	{ "X3DDragSensorNode",            X3D_DRAGSENSOR_NODE,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DDragSensorNode,            NULL },
	{ "X3DEnvironmentalSensorNode",   X3D_ENVIRONMENTALSENSOR_NODE,   JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DEnvironmentalSensorNode,   NULL },
	{ "X3DEnvironmentTextureNode",    X3D_ENVIRONMENTTEXTURE_NODE,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DEnvironmentTextureNode,    NULL },
	{ "X3DFogObject",                 X3D_FOG_OBJECT,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DFogObject,                 NULL },
	{ "X3DFollowerNode",              X3D_FOLLOWER_NODE,              JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DFollowerNode,              NULL },
	{ "X3DFontStyleNode",             X3D_FONTSTYLE_NODE,             JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DFontStyleNode,             NULL },
	{ "X3DGeometricPropertyNode",     X3D_GEOMETRICPROPERTY_NODE,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DGeometricPropertyNode,     NULL },
	{ "X3DGeometryNode",              X3D_GEOMETRY_NODE,              JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DGeometryNode,              NULL },
	{ "X3DGroupingNode",              X3D_GROUPING_NODE,              JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DGroupingNode,              NULL },
	{ "X3DInfoNode",                  X3D_INFO_NODE,                  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DInfoNode,                  NULL },
	{ "X3DInterpolatorNode",          X3D_INTERPOLATOR_NODE,          JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DInterpolatorNode,          NULL },
	{ "X3DKeyDeviceSensorNode",       X3D_KEYDEVICESENSOR_NODE,       JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DKeyDeviceSensorNode,       NULL },
	{ "X3DLayerNode",                 X3D_LAYER_NODE,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DLayerNode,                 NULL },
	{ "X3DLayoutNode",                X3D_LAYOUT_NODE,                JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DLayoutNode,                NULL },
	{ "X3DLightNode",                 X3D_LIGHT_NODE,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DLightNode,                 NULL },
	{ "X3DMaterialNode",              X3D_MATERIAL_NODE,              JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DMaterialNode,              NULL },
	{ "X3DMetadataObject",            X3D_METADATA_OBJECT,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DMetadataObject,            NULL },
	{ "X3DNBodyCollidableNode",       X3D_NBODYCOLLIDABLE_NODE,       JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNBodyCollidableNode,       NULL },
	{ "X3DNBodyCollisionSpaceNode",   X3D_NBODYCOLLISIONSPACE_NODE,   JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNBodyCollisionSpaceNode,   NULL },
	{ "X3DNetworkSensorNode",         X3D_NETWORKSENSOR_NODE,         JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNetworkSensorNode,         NULL },
	{ "X3DNode",                      X3D_NODE,                       JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNode,                      NULL },
	{ "X3DNormalNode",                X3D_NORMAL_NODE,                JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNormalNode,                NULL },
	{ "X3DNurbsControlCurveNode",     X3D_NURBSCONTROLCURVE_NODE,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNurbsControlCurveNode,     NULL },
	{ "X3DNurbsSurfaceGeometryNode",  X3D_NURBSSURFACEGEOMETRY_NODE,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DNurbsSurfaceGeometryNode,  NULL },
	{ "X3DParametricGeometryNode",    X3D_PARAMETRICGEOMETRY_NODE,    JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DParametricGeometryNode,    NULL },
	{ "X3DParticleEmitterNode",       X3D_PARTICLEEMITTER_NODE,       JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DParticleEmitterNode,       NULL },
	{ "X3DParticlePhysicsModelNode",  X3D_PARTICLEPHYSICSMODEL_NODE,  JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DParticlePhysicsModelNode,  NULL },
	{ "X3DPickableObject",            X3D_PICKABLE_OBJECT,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DPickableObject,            NULL },
	{ "X3DPickingNode",               X3D_PICKING_NODE,               JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DPickingNode,               NULL },
	{ "X3DPickSensorNode",            X3D_PICKSENSOR_NODE,            JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DPickSensorNode,            NULL },
	...
	{ "X3DShapeNode",                 X3D_SHAPE_NODE,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DShapeNode,                 NULL },
	{ "X3DSoundNode",                 X3D_SOUND_NODE,                 JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DSoundNode,                 NULL },
	{ "X3DSoundSourceNode",           X3D_SOUNDSOURCE_NODE,           JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DSoundSourceNode,           NULL },
	{ "X3DTexture2DNode",             X3D_TEXTURE2D_NODE,             JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DTexture2DNode,             NULL },
	{ "X3DTexture3DNode",             X3D_TEXTURE3D_NODE,             JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DTexture3DNode,             NULL },
	{ "X3DTextureCoordinateNode",     X3D_TEXTURECOORDINATE_NODE,     JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DTextureCoordinateNode,     NULL },
	{ "X3DTextureNode",               X3D_TEXTURE_NODE,               JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DTextureNode,               NULL },
	...
	{ "X3DViewpointNode",             X3D_VIEWPOINT_NODE,             JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DViewpointNode,             NULL },
	{ "X3DViewpointObject",           X3D_VIEWPOINT_OBJECT,           JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DViewpointObject,           NULL },
	{ "X3DViewportNode",              X3D_VIEWPORT_NODE,              JSPROP_ENUMERATE | JSPROP_READONLY | JSPROP_SHARED | JSPROP_PERMANENT, X3DViewportNode,              NULL },
