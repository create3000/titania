...
const JSFunctionSpec ProfileInfo::functions [ ] = {
	JS_FS_END
};

JSObject*
ProfileInfo::init (JSContext* const cx, JS::HandleObject global, JS::HandleObject parent)
{
...
bool
ProfileInfo::construct (JSContext* cx, unsigned argc, JS::Value* vp)
{
...
bool
ProfileInfo::getName (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
...
bool
ProfileInfo::getTitle (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto   args = JS::CallArgsFromVp (argc, vp);
...
bool
ProfileInfo::getProviderUrl (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto   args = JS::CallArgsFromVp (argc, vp);
...
bool
ProfileInfo::getComponents (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto   args = JS::CallArgsFromVp (argc, vp);
