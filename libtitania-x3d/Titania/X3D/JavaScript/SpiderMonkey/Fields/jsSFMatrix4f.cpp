...
JSBool
jsSFMatrix4f::resolve (JSContext* context, JSObject* obj, jsid id)
{
...
JSBool
jsSFMatrix4f::get1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);

	return JS_NewNumberValue (context, sfmatrix4f -> get1Value (JSID_TO_INT (id)), vp);
}

JSBool
jsSFMatrix4f::set1Value (JSContext* context, JSObject* obj, jsid id, JSBool strict, jsval* vp)
{
	SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
	...
	sfmatrix4f -> set1Value (JSID_TO_INT (id), value);

	return JS_TRUE;
}

JSBool
jsSFMatrix4f::setTransform (JSContext* context, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
...
JSBool
jsSFMatrix4f::getTransform (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix4f::transpose (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix4f::inverse (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix4f::multLeft (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f1 = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix4f::multRight (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f1 = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix4f::multVecMatrix (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix4f::multMatrixVec (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
