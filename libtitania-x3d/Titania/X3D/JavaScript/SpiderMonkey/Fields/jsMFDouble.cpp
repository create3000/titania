...
template <>
JSBool
jsX3DArrayField <jsSFDouble, MFDouble>::unshift (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		jsdouble value;
...
template <>
JSBool
jsX3DArrayField <jsSFDouble, MFDouble>::push (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		jsdouble value;
