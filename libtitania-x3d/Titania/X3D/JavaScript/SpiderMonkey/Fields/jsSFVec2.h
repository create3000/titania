...
template <class Type>
JSBool
jsSFVec2 <Type>::create (JSContext* const context, Type* const field, jsval* const vp)
{
...
template <class Type>
JSBool
jsSFVec2 <Type>::multVec (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		Type* const self = (Type*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
template <class Type>
JSBool
jsSFVec2 <Type>::divVec (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		Type* const self = (Type*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
