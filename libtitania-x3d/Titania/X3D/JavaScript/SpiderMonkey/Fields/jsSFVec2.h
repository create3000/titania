...
template <class Type>
JS::Value
jsSFVec2 <Type>::create (JSContext* const cx, Type* const field)
throw (std::invalid_argument)
{
...
template <class Type>
JSBool
jsSFVec2 <Type>::construct (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		switch (argc)
...
template <class Type>
JSBool
jsSFVec2 <Type>::set1Value (JSContext* cx, JS::HandleObject obj, JS::HandleId id, JSBool strict, JS::MutableHandleValue vp)
{
	try
	{
...
template <class Type>
JSBool
jsSFVec2 <Type>::get1Value (JSContext* cx, JS::HandleObject obj, JS::HandleId id, JS::MutableHandleValue vp)
{
	try
	{
		const auto lhs = getThis <jsSFVec2> (cx, obj);
...
template <size_t Index>
JSBool
jsSFVec2 <Type>::setProperty (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto args = JS::CallArgsFromVp (argc, vp);
		const auto lhs  = getThis <jsSFVec2> (cx, args);
...
template <size_t Index>
JSBool
jsSFVec2 <Type>::getProperty (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto args = JS::CallArgsFromVp (argc, vp);
...
template <class Type>
JSBool
jsSFVec2 <Type>::negate (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 0)
...
template <class Type>
JSBool
jsSFVec2 <Type>::add (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
	...
	try
	{
		const auto args = JS::CallArgsFromVp (argc, vp);
		const auto lhs  = getThis <jsSFVec2> (cx, args);
		const auto rhs  = getArgument <jsSFVec2> (cx, args, 0);
...
template <class Type>
JSBool
jsSFVec2 <Type>::subtract (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
...
template <class Type>
JSBool
jsSFVec2 <Type>::multiply (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
...
template <class Type>
JSBool
jsSFVec2 <Type>::multVec (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
...
template <class Type>
JSBool
jsSFVec2 <Type>::divide (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
...
template <class Type>
JSBool
jsSFVec2 <Type>::divVec (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
...
template <class Type>
JSBool
jsSFVec2 <Type>::normalize (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 0)
...
template <class Type>
JSBool
jsSFVec2 <Type>::dot (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 1)
...
template <class Type>
JSBool
jsSFVec2 <Type>::length (JSContext* cx, unsigned argc, JS::Value* vp)
{
	if (argc not_eq 0)
