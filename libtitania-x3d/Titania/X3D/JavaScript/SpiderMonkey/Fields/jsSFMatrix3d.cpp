...
jsSFMatrix3d::transpose (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		...
		return create (context, sfmatrix3d -> transpose (), &JS_RVAL (cx, vp));
	}
...
jsSFMatrix3d::inverse (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		...
		return create (context, sfmatrix3d -> inverse (), &JS_RVAL (cx, vp));
	}
...
jsSFMatrix3d::multLeft (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		...
		return create (context, sfmatrix3d1 -> multLeft (*sfmatrix3d2), &JS_RVAL (cx, vp));
	}
...
jsSFMatrix3d::multRight (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		...
		return create (context, sfmatrix3d1 -> multRight (*sfmatrix3d2), &JS_RVAL (cx, vp));
	}
...
jsSFMatrix3d::multVecMatrix (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		...
		return jsSFVec2d::create (context, sfmatrix3d -> multVecMatrix (*vec), &JS_RVAL (cx, vp));
	}
...
jsSFMatrix3d::multMatrixVec (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		...
		return jsSFVec2d::create (context, sfmatrix3d -> multMatrixVec (*vec), &JS_RVAL (cx, vp));
	}
