...
JSBool
jsSFMatrix3d::construct (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		return create (context, new SFMatrix3d (), &JS_RVAL (context, vp));
	}
	else if (argc == size)
	{
		...
		return create (context, new SFMatrix3d (m11, m12, m13, m21, m22, m23, m31, m32, m33), &JS_RVAL (context, vp));
	}
...
JSBool
jsSFMatrix3d::get1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
...
JSBool
jsSFMatrix3d::set1Value (JSContext* context, JSObject* obj, jsid id, JSBool strict, jsval* vp)
{
	SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::setTransform (JSContext* context, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix3d::getTransform (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		//SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsSFMatrix3d::transpose (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));

		return create (context, sfmatrix3d -> transpose (), &JS_RVAL (context, vp));
	}
...
JSBool
jsSFMatrix3d::inverse (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));

		return create (context, sfmatrix3d -> inverse (), &JS_RVAL (context, vp));
	}
...
JSBool
jsSFMatrix3d::multLeft (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d1 = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return create (context, sfmatrix3d1 -> multLeft (*sfmatrix3d2), &JS_RVAL (context, vp));
	}
...
JSBool
jsSFMatrix3d::multRight (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d1 = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return create (context, sfmatrix3d1 -> multRight (*sfmatrix3d2), &JS_RVAL (context, vp));
	}
...
JSBool
jsSFMatrix3d::multVecMatrix (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return jsSFVec2d::create (context, sfmatrix3d -> multVecMatrix (*vec), &JS_RVAL (context, vp));
	}
...
JSBool
jsSFMatrix3d::multMatrixVec (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return jsSFVec2d::create (context, sfmatrix3d -> multMatrixVec (*vec), &JS_RVAL (context, vp));
	}
