...
JSBool
jsMFVec2d::construct (JSContext* context, uintN argc, jsval* vp)
{
	...
	else
	{
		...
		JS_SetPrivate (context, obj, new MFVec2d (values, values + argc));
...
JSBool
jsMFVec2d::set1Value (JSContext* context, JSObject* obj, jsid id, JSBool strict, jsval* vp)
{
	if (not JSVAL_IS_INT (id))
		return JS_PropertyStub (context, obj, id, vp);
