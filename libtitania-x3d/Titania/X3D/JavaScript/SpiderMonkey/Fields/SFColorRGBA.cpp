...
const JSPropertySpec SFColorRGBA::properties [ ] = {
	...
	JS_PSGS ("a", getProperty <A>, setProperty <A>, JSPROP_PERMANENT | JSPROP_ENUMERATE),
	...
	JS_PSGS ("3", getProperty <A>, setProperty <A>, JSPROP_PERMANENT),
	JS_PS_END
};
...
JSObject*
SFColorRGBA::init (JSContext* const cx, JS::HandleObject global, JS::HandleObject parent)
{
...
bool
SFColorRGBA::construct (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		switch (argc)
...
bool
SFColorRGBA::setProperty (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto args = JS::CallArgsFromVp (argc, vp);
...
template <size_t Index>
bool
SFColorRGBA::getProperty (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		const auto args = JS::CallArgsFromVp (argc, vp);
...
bool
SFColorRGBA::getHSVA (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		if (argc not_eq 0)
...
bool
SFColorRGBA::setHSVA (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		if (argc not_eq 4)
...
bool
SFColorRGBA::lerp (JSContext* cx, unsigned argc, JS::Value* vp)
{
	try
	{
		if (argc not_eq 2)
