...
JSBool
jsVrmlMatrix::create (JSContext* context, SFMatrix4d* field, jsval* vp, const bool seal)
{
...
JSBool
jsVrmlMatrix::construct (JSContext* context, uintN argc, jsval* vp)
{
...
JSBool
jsVrmlMatrix::resolve (JSContext* context, JSObject* obj, jsid id)
{
...
JSBool
jsVrmlMatrix::get1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
...
JSBool
jsVrmlMatrix::set1Value (JSContext* context, JSObject* obj, jsid id, JSBool strict, jsval* vp)
{
	SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::setTransform (JSContext* context, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
...
JSBool
jsVrmlMatrix::getTransform (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
...
JSBool
jsVrmlMatrix::transpose (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));

		return create (context, sfmatrix4d -> transpose (), &JS_RVAL (cx, vp));
	}
...
JSBool
jsVrmlMatrix::inverse (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));

		return create (context, sfmatrix4d -> inverse (), &JS_RVAL (cx, vp));
	}
...
JSBool
jsVrmlMatrix::multLeft (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		...
		return create (context, sfmatrix4d1 -> multLeft (*sfmatrix4d2), &JS_RVAL (cx, vp));
	}
...
JSBool
jsVrmlMatrix::multRight (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d1 = (SFMatrix4d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return create (context, sfmatrix4d1 -> multRight (*sfmatrix4d2), &JS_RVAL (cx, vp));
	}
...
JSBool
jsVrmlMatrix::multVecMatrix (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return jsSFVec3d::create (context, sfmatrix4d -> multVecMatrix (*vec), &JS_RVAL (cx, vp));
	}
...
JSBool
jsVrmlMatrix::multMatrixVec (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
		...
		return jsSFVec3d::create (context, sfmatrix4d -> multMatrixVec (*vec), &JS_RVAL (cx, vp));
	}
