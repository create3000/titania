...
jsX3DArrayField <jsSFTime, MFTime>::set1Value (JSContext* context, JSObject* obj, jsid id, JSBool strict, jsval* vp)
{
	...
	MFTime* const field = (MFTime*) JS_GetPrivate (context, obj);
...
jsX3DArrayField <jsSFTime, MFTime>::unshift (JSContext* context, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		...
		MFTime* const field = (MFTime*) JS_GetPrivate (context, JS_THIS_OBJECT (context, vp));
