...
JSBool
jsSFMatrix3d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFMatrix3d::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
...
JSBool
jsSFMatrix3d::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d1 = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3d::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3d* sfmatrix3d = (SFMatrix3d*) JS_GetPrivate (context, obj);
