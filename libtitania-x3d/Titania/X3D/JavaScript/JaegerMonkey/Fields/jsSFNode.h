	...
	public jsX3DField
{
	...
	static JSBool         getNodeName (JSContext*, JSObject*, uintN, jsval*);
	static JSBool         getNodeType (JSContext*, JSObject*, uintN, jsval*);
	static JSBool         getFieldDefinitions (JSContext*, JSObject*, uintN, jsval*);
	static JSBool         toVRMLString (JSContext*, JSObject*, uintN, jsval*);
	static JSBool         toXMLString (JSContext*, JSObject*, uintN, jsval*);
	static JSBool         toString (JSContext*, JSObject*, uintN, jsval*);
...
public:
	...
	static JSBool
	create (JSContext*, SFNode <X3DBasicNode>*, jsval*, const bool = false);
