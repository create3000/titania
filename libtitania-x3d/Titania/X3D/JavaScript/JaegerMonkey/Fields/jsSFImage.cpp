...
JSBool
jsSFImage::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFImage::setWidth (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFImage* sfimage = (SFImage*) JS_GetPrivate (context, obj);
...
JSBool
jsSFImage::setHeight (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFImage* sfimage = (SFImage*) JS_GetPrivate (context, obj);
...
JSBool
jsSFImage::setComp (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFImage* sfimage = (SFImage*) JS_GetPrivate (context, obj);
...
JSBool
jsSFImage::setArray (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFImage* sfimage = (SFImage*) JS_GetPrivate (context, obj);
