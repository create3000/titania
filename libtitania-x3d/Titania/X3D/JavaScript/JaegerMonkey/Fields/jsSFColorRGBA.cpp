...
JSBool
jsSFColorRGBA::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFColorRGBA::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFColorRGBA* sfcolorrgba = (SFColorRGBA*) JS_GetPrivate (context, obj);
...
JSBool
jsSFColorRGBA::getHSV (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFColorRGBA* sfcolorrgba = (SFColorRGBA*) JS_GetPrivate (context, obj);
...
JSBool
jsSFColorRGBA::setHSV (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFColorRGBA* sfcolorrgba = (SFColorRGBA*) JS_GetPrivate (context, obj);
