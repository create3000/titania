...
JSBool
jsSFMatrix3f::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFMatrix3f::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
...
JSBool
jsSFMatrix3f::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f1 = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
