...
JSBool
jsMFRotation::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsMFRotation::get1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
...
JSBool
jsMFRotation::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	if (not JSVAL_IS_INT (id))
		return JS_PropertyStub (context, obj, id, vp);
