...
JSBool
jsSFMatrix4d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFMatrix4d::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
...
JSBool
jsSFMatrix4d::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d1 = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
