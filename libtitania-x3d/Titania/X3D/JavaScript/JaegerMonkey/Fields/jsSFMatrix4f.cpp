...
JSBool
jsSFMatrix4f::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFMatrix4f::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
...
JSBool
jsSFMatrix4f::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f1 = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
