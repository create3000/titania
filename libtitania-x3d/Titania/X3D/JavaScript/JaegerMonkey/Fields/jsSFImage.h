	...
	public jsX3DField
{
	...
	static JSBool         setWidth (JSContext*, JSObject*, jsid, jsval*);
	static JSBool         getHeight (JSContext*, JSObject*, jsid, jsval*);
	static JSBool         setHeight (JSContext*, JSObject*, jsid, jsval*);
	static JSBool         getComp (JSContext*, JSObject*, jsid, jsval*);
	static JSBool         setComp (JSContext*, JSObject*, jsid, jsval*);
	static JSBool         getArray (JSContext*, JSObject*, jsid, jsval*);
	static JSBool         setArray (JSContext*, JSObject*, jsid, jsval*);
