...
JSBool
jsSFColor::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsSFColor::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);
...
JSBool
jsSFColor::getHSV (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);
...
JSBool
jsSFColor::setHSV (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);
