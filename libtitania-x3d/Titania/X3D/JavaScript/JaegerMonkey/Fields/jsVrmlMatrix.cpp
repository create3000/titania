...
JSBool
jsVrmlMatrix::construct (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
...
JSBool
jsVrmlMatrix::set1Value (JSContext* context, JSObject* obj, jsid id, jsval* vp)
{
	SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 3)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
...
JSBool
jsVrmlMatrix::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f1 = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsVrmlMatrix::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* vp)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
