...
JSBool
jsX3DFieldDefinition::getName (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsX3DFieldDefinition::getAccessType (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	X3DFieldDefinition* field = (X3DFieldDefinition*) JS_GetPrivate (context, obj);

	return JS_NewDoubleValue (context, field -> getAccessType (), vp);
}

JSBool
jsX3DFieldDefinition::getDataType (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	X3DFieldDefinition* field = (X3DFieldDefinition*) JS_GetPrivate (context, obj);

	return JS_NewDoubleValue (context, field -> getType (), vp);
}
