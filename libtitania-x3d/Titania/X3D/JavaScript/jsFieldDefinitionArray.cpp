...
JSBool
jsFieldDefinitionArray::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsFieldDefinitionArray::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	if (not JSVAL_IS_INT (id))
		return JS_PropertyStub (context, obj, id, vp);
...
JSBool
jsFieldDefinitionArray::getLength (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	FieldDefinitionArray* array = (FieldDefinitionArray*) JS_GetPrivate (context, obj);
...
JSBool
jsFieldDefinitionArray::setLength (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	return JS_TRUE;
}
