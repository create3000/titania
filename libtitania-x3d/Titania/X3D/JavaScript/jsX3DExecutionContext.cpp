...
JSBool
jsX3DExecutionContext::getRootNodes (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsX3DExecutionContext::setRootNodes (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	X3DExecutionContext* executionContext = (X3DExecutionContext*) JS_GetPrivate (context, obj);
...
JSBool
jsX3DExecutionContext::createNode (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		try
