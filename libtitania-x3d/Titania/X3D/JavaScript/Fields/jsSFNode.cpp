...
JSBool
jsSFNode::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
...
JSBool
jsSFNode::getProperty (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsSFNode::setProperty (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	if (JSVAL_IS_STRING (id))
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);
...
JSBool
jsSFNode::getNodeName (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);

		return JS_NewStringValue (context, *sfnode ? sfnode -> getValue () -> getName () : "", rval);
	}
...
JSBool
jsSFNode::getNodeType (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);
...
JSBool
jsSFNode::getFieldDefinitions (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);
...
JSBool
jsSFNode::toVRMLString (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);

		return JS_NewStringValue (context, *sfnode, rval);
	}
...
JSBool
jsSFNode::toXMLString (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);

		return JS_NewStringValue (context, "", rval);
	}
...
JSBool
jsSFNode::toString (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFNode* sfnode = (SFNode*) JS_GetPrivate (context, obj);
		...
		if (*sfnode)
			return JS_NewStringValue (context, sfnode -> getValue () -> getTypeName () + " { }", rval);
		else
			return JS_NewStringValue (context, *sfnode, rval);
	}
