...
JSBool
jsSFVec4d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	jsdouble x = 0;
	jsdouble y = 0;
	jsdouble z = 0;
...
JSBool
jsSFVec4d::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsSFVec4d::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFVec4d* sfvec4d = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::getReal (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4d* sfvec4d = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::negate (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4d* sfvec4d = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::add (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
...
JSBool
jsSFVec4d::subtract (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4d* sfvec4d1 = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::multiply (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4d* sfvec4d1 = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::divide (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4d* sfvec4d1 = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::dot (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4d* sfvec4d1 = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::normalize (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4d* sfvec4d = (SFVec4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4d::length (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4d* sfvec4d = (SFVec4d*) JS_GetPrivate (context, obj);
