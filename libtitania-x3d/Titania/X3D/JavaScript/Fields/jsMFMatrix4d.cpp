...
#include "jsMFMatrix4d.h"

namespace Titania {
namespace X3D {

JSClass jsMFMatrix4d::static_class = {
...
void
jsMFMatrix4d::init (JSContext* context, JSObject* global)
{
...
JSBool
jsMFMatrix4d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		JS_SetPrivate (context, obj, new MFMatrix4d ());
		return JS_TRUE;
	}
	else
	{
		SFMatrix4d values [argc];

		for (MFMatrix4d::size_type i = 0; i < argc; ++ i)
		{
			JSObject* obj2;
		...
		JS_SetPrivate (context, obj, new MFMatrix4d (values, argc));
...
JSBool
jsMFMatrix4d::enumerate (JSContext* context, JSObject* obj, JSIterateOp enum_op, jsval* statep, jsid* idp)
{
	MFMatrix4d* x3darrayfield = (MFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsMFMatrix4d::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsMFMatrix4d::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	if (not JSVAL_IS_INT (id))
		return JS_PropertyStub (context, obj, id, vp);
