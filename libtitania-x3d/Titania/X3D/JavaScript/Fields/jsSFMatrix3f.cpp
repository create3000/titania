...
JSBool
jsSFMatrix3f::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
...
JSBool
jsSFMatrix3f::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);

	return JS_NewDoubleValue (context, sfmatrix3f -> get1Value (JSVAL_TO_INT (id)), vp);
}

JSBool
jsSFMatrix3f::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::resolve (JSContext* context, JSObject* obj, jsval id)
{
...
JSBool
jsSFMatrix3f::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 3)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix3f::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);

		return create (context, sfmatrix3f -> inverse (), rval);
	}
...
JSBool
jsSFMatrix3f::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);

		return create (context, sfmatrix3f -> transpose (), rval);
	}
...
JSBool
jsSFMatrix3f::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f1 = (SFMatrix3f*) JS_GetPrivate (context, obj);
		...
		return create (context, sfmatrix3f1 -> multLeft (*sfmatrix3f2), rval);
	}
...
JSBool
jsSFMatrix3f::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f1 = (SFMatrix3f*) JS_GetPrivate (context, obj);
		...
		return create (context, sfmatrix3f1 -> multRight (*sfmatrix3f2), rval);
	}
...
JSBool
jsSFMatrix3f::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
		...
		return jsSFVec2f::create (context, sfmatrix3f -> multVecMatrix (*vec), rval);
	}
...
JSBool
jsSFMatrix3f::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix3f* sfmatrix3f = (SFMatrix3f*) JS_GetPrivate (context, obj);
		...
		return jsSFVec2f::create (context, sfmatrix3f -> multMatrixVec (*vec), rval);
	}
