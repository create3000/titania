...
JSBool
jsSFMatrix4d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		JS_SetPrivate (context, obj, new SFMatrix4d ());
		return JS_TRUE;
	}
	else if (argc == size)
	{
		...
		JS_SetPrivate (context, obj, new SFMatrix4d (m11, m12, m13, m14, m21, m22, m23, m24, m31, m32, m33, m34, m41, m42, m43, m44));
...
JSBool
jsSFMatrix4d::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);

	return JS_NewDoubleValue (context, sfmatrix4d -> get1Value (JSVAL_TO_INT (id)), vp);
}

JSBool
jsSFMatrix4d::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::resolve (JSContext* context, JSObject* obj, jsval id)
{
...
JSBool
jsSFMatrix4d::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 3)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4d::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);

		return create (context, sfmatrix4d -> inverse (), rval);
	}
...
JSBool
jsSFMatrix4d::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);

		return create (context, sfmatrix4d -> transpose (), rval);
	}
...
JSBool
jsSFMatrix4d::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d1 = (SFMatrix4d*) JS_GetPrivate (context, obj);
		...
		return create (context, sfmatrix4d1 -> multLeft (*sfmatrix4d2), rval);
	}
...
JSBool
jsSFMatrix4d::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d1 = (SFMatrix4d*) JS_GetPrivate (context, obj);
		...
		return create (context, sfmatrix4d1 -> multRight (*sfmatrix4d2), rval);
	}
...
JSBool
jsSFMatrix4d::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
		...
		return jsSFVec3d::create (context, sfmatrix4d -> multVecMatrix (*vec), rval);
	}
...
JSBool
jsSFMatrix4d::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4d* sfmatrix4d = (SFMatrix4d*) JS_GetPrivate (context, obj);
		...
		return jsSFVec3d::create (context, sfmatrix4d -> multMatrixVec (*vec), rval);
	}
