...
const size_t jsSFMatrix4f::size = 16;

JSClass jsSFMatrix4f::static_class = {
...
JSFunctionSpec jsSFMatrix4f::functions [ ] = {
...
void
jsSFMatrix4f::init (JSContext* context, JSObject* global)
{
...
JSBool
jsSFMatrix4f::create (JSContext* context, SFMatrix4f* field, jsval* vp, const bool seal)
{
...
JSBool
jsSFMatrix4f::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
...
JSBool
jsSFMatrix4f::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsSFMatrix4f::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::enumerate (JSContext* context, JSObject* obj, JSIterateOp enum_op, jsval* statep, jsid* idp)
{
...
JSBool
jsSFMatrix4f::resolve (JSContext* context, JSObject* obj, jsval id)
{
...
JSBool
jsSFMatrix4f::setTransform (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc >= 0 or argc <= 5)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::getTransform (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 3)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::inverse (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::transpose (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::multLeft (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		...
		{
			JS_ReportError (context, "Type of argument 1 is invalid - should be SFMatrix4f, is %s", JS_GetClass (context, obj2) -> name);
			return JS_FALSE;
		}
...
JSBool
jsSFMatrix4f::multRight (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f1 = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::multVecMatrix (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFMatrix4f::multMatrixVec (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFMatrix4f* sfmatrix4f = (SFMatrix4f*) JS_GetPrivate (context, obj);
