...
JSBool
jsSFVec2d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	jsdouble x = 0;
	jsdouble y = 0;
...
JSBool
jsSFVec2d::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsSFVec2d::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFVec2d* sfvec2d = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::negate (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec2d* sfvec2d = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::add (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
...
JSBool
jsSFVec2d::subtract (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec2d* sfvec2d1 = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::multiply (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec2d* sfvec2d1 = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::divide (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec2d* sfvec2d1 = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::dot (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec2d* sfvec2d1 = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::normalize (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec2d* sfvec2d = (SFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec2d::length (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec2d* sfvec2d = (SFVec2d*) JS_GetPrivate (context, obj);
