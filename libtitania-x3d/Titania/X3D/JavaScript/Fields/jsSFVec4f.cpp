...
JSBool
jsSFVec4f::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	jsdouble x = 0;
	jsdouble y = 0;
	jsdouble z = 0;
...
JSBool
jsSFVec4f::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsSFVec4f::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFVec4f* sfvec4f = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::getReal (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4f* sfvec4f = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::negate (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4f* sfvec4f = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::add (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
...
JSBool
jsSFVec4f::subtract (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4f* sfvec4f1 = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::multiply (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4f* sfvec4f1 = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::divide (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4f* sfvec4f1 = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::dot (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 1)
	{
		SFVec4f* sfvec4f1 = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::normalize (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4f* sfvec4f = (SFVec4f*) JS_GetPrivate (context, obj);
...
JSBool
jsSFVec4f::length (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFVec4f* sfvec4f = (SFVec4f*) JS_GetPrivate (context, obj);
