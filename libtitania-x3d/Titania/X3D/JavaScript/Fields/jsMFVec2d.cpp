...
JSClass jsMFVec2d::static_class = {
...
void
jsMFVec2d::init (JSContext* context, JSObject* global)
{
...
JSBool
jsMFVec2d::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		JS_SetPrivate (context, obj, new MFVec2d ());
		return JS_TRUE;
	}
	else
	{
		...
		for (MFVec2d::size_type i = 0; i < argc; ++ i)
		{
			JSObject* obj2;
		...
		JS_SetPrivate (context, obj, new MFVec2d (values, argc));
...
JSBool
jsMFVec2d::enumerate (JSContext* context, JSObject* obj, JSIterateOp enum_op, jsval* statep, jsid* idp)
{
	MFVec2d* x3darrayfield = (MFVec2d*) JS_GetPrivate (context, obj);
...
JSBool
jsMFVec2d::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
...
JSBool
jsMFVec2d::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	if (not JSVAL_IS_INT (id))
		return JS_PropertyStub (context, obj, id, vp);
