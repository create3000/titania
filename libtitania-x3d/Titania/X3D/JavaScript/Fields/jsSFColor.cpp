...
JSBool
jsSFColor::construct (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		JS_SetPrivate (context, obj, new SFColor ());
		return JS_TRUE;
	}
	else if (argc == size)
	{
		...
		JS_SetPrivate (context, obj, new SFColor (r, g, b));
...
JSBool
jsSFColor::get1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);

	return JS_NewDoubleValue (context, sfcolor -> get1Value (JSVAL_TO_INT (id)), vp);
}

JSBool
jsSFColor::set1Value (JSContext* context, JSObject* obj, jsval id, jsval* vp)
{
	SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);
...
JSBool
jsSFColor::getHSV (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 0)
	{
		SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);
...
JSBool
jsSFColor::setHSV (JSContext* context, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	if (argc == 3)
	{
		SFColor* sfcolor = (SFColor*) JS_GetPrivate (context, obj);
