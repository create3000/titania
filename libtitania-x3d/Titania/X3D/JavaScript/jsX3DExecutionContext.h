...
class jsX3DExecutionContext
{
	...
	static JSBool         getRootNodes (JSContext *, JSObject *, jsval, jsval*);
	static JSBool         setRootNodes (JSContext *, JSObject *, jsval, jsval*);
	static JSBool         createNode (JSContext *, JSObject *, uintN, jsval *, jsval*);
