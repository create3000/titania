...
Context::resolve (pb::pbObject* const object, const pb::Identifier & identifier)
{
	...
	static const std::map <pb::Identifier, ObjectType> types = {
		...
		// Fields
		std::make_pair ("SFColor",       SFColor::getType ()),
		std::make_pair ("SFColorRGBA",   SFColorRGBA::getType ()),
		std::make_pair ("SFImage",       SFImage::getType ()),
		std::make_pair ("SFMatrix3d",    SFMatrix3d::getType ()),
		...
		std::make_pair ("SFVec3d",       SFVec3d::getType ()),
		std::make_pair ("SFVec3f",       SFVec3f::getType ()),
		std::make_pair ("SFVec4d",       SFVec4d::getType ()),
		std::make_pair ("SFVec4f",       SFVec4f::getType ()),

		// Array Fields
		std::make_pair ("MFBool",        MFBool::getType ()),
		std::make_pair ("MFColor",       MFColor::getType ()),
		std::make_pair ("MFColorRGBA",   MFColorRGBA::getType ()),
		std::make_pair ("MFDouble",      MFDouble::getType ()),
		std::make_pair ("MFFloat",       MFFloat::getType ()),
		std::make_pair ("MFImage",       MFImage::getType ()),
		std::make_pair ("MFInt32",       MFInt32::getType ()),
		std::make_pair ("MFMatrix3d",    MFMatrix3d::getType ()),
		...
		std::make_pair ("MFVec2d",       MFVec2d::getType ()),
		std::make_pair ("MFVec2f",       MFVec2f::getType ()),
