...
Context::resolve (pb::pbObject* const object, const pb::Identifier & identifier)
{
	...
	static const std::map <pb::Identifier, ObjectType> types = {
		...
		// Fields
		std::make_pair (pb::Identifier ("SFColor"),       SFColor::getType ()),
		std::make_pair (pb::Identifier ("SFColorRGBA"),   SFColorRGBA::getType ()),
		std::make_pair (pb::Identifier ("SFImage"),       SFImage::getType ()),
		std::make_pair (pb::Identifier ("SFRotation"),    SFRotation::getType ()),
		...
		std::make_pair (pb::Identifier ("MFColor"),       MFColor::getType ()),
		std::make_pair (pb::Identifier ("MFColorRGBA"),   MFColorRGBA::getType ()),
		std::make_pair (pb::Identifier ("MFDouble"),      MFDouble::getType ()),
		std::make_pair (pb::Identifier ("MFFloat"),       MFFloat::getType ()),
		std::make_pair (pb::Identifier ("MFImage"),       MFImage::getType ()),
		...
		std::make_pair (pb::Identifier ("MFRotation"),    MFRotation::getType ()),
