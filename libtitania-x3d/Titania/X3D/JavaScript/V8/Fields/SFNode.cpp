...
SFNode::initialize (const v8::Local <v8::External> & context)
{
	...
	instanceTemplate -> SetNamedPropertyHandler (getProperty, setProperty, hasProperty, nullptr, getPropertyNames, context);
...
SFNode::setProperty (v8::Local <v8::String> property, v8::Local <v8::Value> value, const v8::AccessorInfo & info)
{
	try
	{
		...
		try
		{
			return GoogleV8::setValue (context, field, value);
		}
