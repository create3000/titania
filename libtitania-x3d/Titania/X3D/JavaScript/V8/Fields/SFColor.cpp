...
template <>
const std::string X3DObject <X3D::SFColor>::typeName = "SFColor";

template <>
const ObjectType X3DObject <X3D::SFColor>::type = ObjectType::SFColor;

v8::Local <v8::FunctionTemplate>
SFColor::initialize (const v8::Local <v8::External> & context)
{
...
v8::Handle <v8::Value>
SFColor::construct (const v8::Arguments & args)
{
...
SFColor::hasIndex (uint32_t index, const v8::AccessorInfo & info)
{
...
v8::Handle <v8::Array>
SFColor::getIndices (const v8::AccessorInfo & info)
{
...
v8::Handle <v8::Value>
SFColor::setHSV (const v8::Arguments & args)
{
	try
	{
...
v8::Handle <v8::Value>
SFColor::getHSV (const v8::Arguments & args)
{
	try
	{
