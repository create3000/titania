...
typedef basic::indexed_map <std::string, const X3DFieldDefinition*> FieldTypesArray;

} // X3D

extern template class basic::indexed_map <std::string, const X3D::X3DFieldDefinition*>;
