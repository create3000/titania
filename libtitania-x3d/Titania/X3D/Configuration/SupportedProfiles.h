...
#ifndef __TITANIA_X3D_CONFIGURATION_SUPPORTED_PROFILES_H__
#define __TITANIA_X3D_CONFIGURATION_SUPPORTED_PROFILES_H__
...
public:
	...
	SupportedProfiles (const std::shared_ptr <SupportedComponents> & supportedComponents);
