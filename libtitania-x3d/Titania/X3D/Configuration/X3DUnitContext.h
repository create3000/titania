...
#ifndef __TITANIA_X3D_CONFIGURATION_X3DUNIT_CONTEXT_H__
#define __TITANIA_X3D_CONFIGURATION_X3DUNIT_CONTEXT_H__
...
public:
	...
	const Unit &
	getUnit (const UnitCategory) const
