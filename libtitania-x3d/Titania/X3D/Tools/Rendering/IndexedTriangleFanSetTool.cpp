...
#include "IndexedTriangleFanSetTool.h"
...
void
IndexedTriangleFanSetTool::initialize ()
{
	X3DComposedGeometryNodeTool::initialize ();
}

void
IndexedTriangleFanSetTool::dispose ()
{
	__LOG__ << std::endl;
...
IndexedTriangleFanSetTool::~IndexedTriangleFanSetTool ()
{ }
