...
public:
	...
	virtual
	MFInt32 &
	vertexCount () final override
	{ return getNode <LineSet> () -> vertexCount (); }

	virtual
	const MFInt32 &
	vertexCount () const final override
	{ return getNode <LineSet> () -> vertexCount (); }

	virtual
	MFNode &
	attrib () final override
	{ return getNode <LineSet> () -> attrib (); }
	...
	{ return getNode <LineSet> () -> fogCoord (); }
