...
TriangleFanSetTool::TriangleFanSetTool (X3DBaseNode* const node) :
	...
	X3DComposedGeometryNodeTool (),
	                     fields ()
{
	addType (X3DConstants::TriangleFanSetTool);
...
void
TriangleFanSetTool::initialize ()
{
	X3DComposedGeometryNodeTool::initialize ();
}

void
TriangleFanSetTool::dispose ()
{
	__LOG__ << std::endl;
...
TriangleFanSetTool::~TriangleFanSetTool ()
{ }
