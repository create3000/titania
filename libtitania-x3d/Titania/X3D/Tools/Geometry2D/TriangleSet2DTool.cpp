...
TriangleSet2DTool::TriangleSet2DTool (TriangleSet2D* const node) :
	...
	X3DGeometryNodeTool (),
	             fields ()
{
	addType (X3DConstants::TriangleSet2DTool);
...
void
TriangleSet2DTool::initialize ()
{
	X3DGeometryNodeTool::initialize ();
}

void
TriangleSet2DTool::dispose ()
{
	__LOG__ << std::endl;
...
TriangleSet2DTool::~TriangleSet2DTool ()
{ }
