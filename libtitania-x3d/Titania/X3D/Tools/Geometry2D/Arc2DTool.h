...
#ifndef __TITANIA_X3D_TOOLS_GEOMETRY2D_ARC2DTOOL_H__
#define __TITANIA_X3D_TOOLS_GEOMETRY2D_ARC2DTOOL_H__
...
public:
	...
	{ getNode <Arc2D> () -> setExecutionContext (executionContext); }
	...
	{ return getNode <Arc2D> () -> startAngle (); }
