...
#ifdef __APPLE__
template <>
const std::string X3DField <Rotation4d>::typeName;

template <>
const std::string X3DField <Rotation4f>::typeName;

template <>
const FieldType X3DField <Rotation4d>::type;

template <>
const FieldType X3DField <Rotation4f>::type;
#endif
