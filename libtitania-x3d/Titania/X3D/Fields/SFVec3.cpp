...
template <>
const basic::id X3DField <Vector3d>::typeName ("SFVec3d");

template <>
const basic::id X3DField <Vector3f>::typeName ("SFVec3f");
...
// SFVec3d and SFVec3f
template class SFVec3 <Vector3d>;
template class SFVec3 <Vector3f>;
