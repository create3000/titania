...
template <>
const basic::id X3DField <Rotation4d>::typeName ("SFRotation");

template <>
const basic::id X3DField <Rotation4f>::typeName ("SFRotation");
...
// SFRotation
template class SFRotation4 <Rotation4d>;
template class SFRotation4 <Rotation4f>;
