...
#ifndef __TITANIA_X3D_COMPONENTS_ENVIRONMENTAL_EFFECTS_FOG_H__
#define __TITANIA_X3D_COMPONENTS_ENVIRONMENTAL_EFFECTS_FOG_H__
...
class Fog :
	public X3DBindableNode, public X3DFogObject
{
public:

	///  @name Construction

	Fog (X3DExecutionContext* const executionContext);
