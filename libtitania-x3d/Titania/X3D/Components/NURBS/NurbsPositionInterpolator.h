...
#ifndef __TITANIA_X3D_COMPONENTS_NURBS_NURBS_POSITION_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_NURBS_NURBS_POSITION_INTERPOLATOR_H__
...
public:
	...
	NurbsPositionInterpolator (X3DExecutionContext* const executionContext);
	...
	virtual
	~NurbsPositionInterpolator () final override;
