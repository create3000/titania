...
#ifndef __TITANIA_X3D_COMPONENTS_NURBS_NURBS_SWUNG_SURFACE_H__
#define __TITANIA_X3D_COMPONENTS_NURBS_NURBS_SWUNG_SURFACE_H__
...
public:
	...
	NurbsSwungSurface (X3DExecutionContext* const executionContext);
