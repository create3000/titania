...
#ifndef __TITANIA_X3D_COMPONENTS_RENDERING_NORMAL_H__
#define __TITANIA_X3D_COMPONENTS_RENDERING_NORMAL_H__
...
public:
	...
	virtual
	void
	addVector (std::vector <Vector3f>&, int32_t) const final override;
