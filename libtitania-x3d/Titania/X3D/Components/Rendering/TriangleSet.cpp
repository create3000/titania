...
const Component   TriangleSet::component      = Component ("Rendering", 1);
...
X3DBaseNode*
TriangleSet::create (X3DExecutionContext* const executionContext) const
{
	return new TriangleSet (executionContext);
}
