...
#ifndef __TITANIA_X3D_COMPONENTS_RENDERING_INDEXED_TRIANGLE_SET_H__
#define __TITANIA_X3D_COMPONENTS_RENDERING_INDEXED_TRIANGLE_SET_H__
...
public:
	...
	IndexedTriangleSet (X3DExecutionContext* const executionContext);
