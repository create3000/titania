...
#ifndef __TITANIA_X3D_COMPONENTS_RENDERING_CLIP_PLANE_H__
#define __TITANIA_X3D_COMPONENTS_RENDERING_CLIP_PLANE_H__
...
public:
	...
	ClipPlane (X3DExecutionContext* const executionContext);
