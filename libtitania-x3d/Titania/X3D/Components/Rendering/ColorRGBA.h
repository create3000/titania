...
#ifndef __TITANIA_X3D_COMPONENTS_RENDERING_COLOR_RGBA_H__
#define __TITANIA_X3D_COMPONENTS_RENDERING_COLOR_RGBA_H__
...
public:
	...
	ColorRGBA (X3DExecutionContext* const executionContext);
