...
#ifndef __TITANIA_X3D_COMPONENTS_RENDERING_INDEXED_TRIANGLE_STRIP_SET_H__
#define __TITANIA_X3D_COMPONENTS_RENDERING_INDEXED_TRIANGLE_STRIP_SET_H__
...
public:
	...
	IndexedTriangleStripSet (X3DExecutionContext* const executionContext);
