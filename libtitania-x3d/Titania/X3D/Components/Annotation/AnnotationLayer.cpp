...
const Component   AnnotationLayer::component      = Component ("Annotation", 2);
const std::string AnnotationLayer::typeName       = "AnnotationLayer";
const std::string AnnotationLayer::containerField = "layers";

AnnotationLayer::Fields::Fields () :
	layoutPolicy (new MFString ()),
	shownGroupID (new MFString ())
{ }
...
X3DBaseNode*
AnnotationLayer::create (X3DExecutionContext* const executionContext) const
{
	return new AnnotationLayer (executionContext);
}

void
AnnotationLayer::initialize ()
{
