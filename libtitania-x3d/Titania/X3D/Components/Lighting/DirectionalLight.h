...
#ifndef __TITANIA_X3D_COMPONENTS_LIGHTING_DIRECTIONAL_LIGHT_H__
#define __TITANIA_X3D_COMPONENTS_LIGHTING_DIRECTIONAL_LIGHT_H__
...
public:
	...
	DirectionalLight (X3DExecutionContext* const executionContext);
