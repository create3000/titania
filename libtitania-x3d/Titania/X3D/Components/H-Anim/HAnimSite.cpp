...
const ComponentType HAnimSite::component      = ComponentType::H_ANIM;
const std::string   HAnimSite::typeName       = "HAnimSite";
...
X3DBaseNode*
HAnimSite::create (X3DExecutionContext* const executionContext) const
{
