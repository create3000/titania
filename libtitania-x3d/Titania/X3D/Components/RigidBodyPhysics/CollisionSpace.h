...
#ifndef __TITANIA_X3D_COMPONENTS_RIGID_BODY_PHYSICS_COLLISION_SPACE_H__
#define __TITANIA_X3D_COMPONENTS_RIGID_BODY_PHYSICS_COLLISION_SPACE_H__
...
public:
	...
	CollisionSpace (X3DExecutionContext* const executionContext);
