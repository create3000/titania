...
#ifndef __TITANIA_X3D_COMPONENTS_RIGID_BODY_PHYSICS_X3DNBODY_COLLIDABLE_NODE_H__
#define __TITANIA_X3D_COMPONENTS_RIGID_BODY_PHYSICS_X3DNBODY_COLLIDABLE_NODE_H__
...
public:
	...
	virtual
	~X3DNBodyCollidableNode () override;
