...
#ifndef __TITANIA_X3D_COMPONENTS_ENVIRONMENTAL_EFFECTS_H__
#define __TITANIA_X3D_COMPONENTS_ENVIRONMENTAL_EFFECTS_H__
...
#include "EnvironmentalEffects/TextureBackground.h"
