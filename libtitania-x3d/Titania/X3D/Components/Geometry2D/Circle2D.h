...
#ifndef __TITANIA_X3D_COMPONENTS_GEOMETRY2D_CIRCLE2D_H__
#define __TITANIA_X3D_COMPONENTS_GEOMETRY2D_CIRCLE2D_H__
...
public:
	...
	Circle2D (X3DExecutionContext* const executionContext);
