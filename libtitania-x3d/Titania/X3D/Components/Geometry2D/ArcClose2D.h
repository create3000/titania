...
#ifndef __TITANIA_X3D_COMPONENTS_GEOMETRY2D_ARC_CLOSE2D_H__
#define __TITANIA_X3D_COMPONENTS_GEOMETRY2D_ARC_CLOSE2D_H__
...
public:
	...
	ArcClose2D (X3DExecutionContext* const executionContext);
