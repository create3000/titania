...
#ifndef __TITANIA_X3D_COMPONENTS_POINTING_DEVICE_SENSOR_TOUCH_SENSOR_H__
#define __TITANIA_X3D_COMPONENTS_POINTING_DEVICE_SENSOR_TOUCH_SENSOR_H__
...
public:
	...
	TouchSensor (X3DExecutionContext* const executionContext);
