...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING3D_IMAGE_TEXTURE3D_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING3D_IMAGE_TEXTURE3D_H__

#include "../Networking/X3DUrlObject.h"
#include "../Texturing3D/X3DTexture3DNode.h"
#include "../../Thread/Texture3DFuture.h"

namespace titania {
namespace X3D {

class ImageTexture3D :
	public X3DTexture3DNode, public X3DUrlObject
{
public:

	///  @name Construction

	ImageTexture3D (X3DExecutionContext* const executionContext);
