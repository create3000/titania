...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING3D_PIXEL_TEXTURE3D_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING3D_PIXEL_TEXTURE3D_H__
...
public:
	...
	PixelTexture3D (X3DExecutionContext* const executionContext);
