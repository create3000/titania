...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING3D_COMPOSED_TEXTURE3D_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING3D_COMPOSED_TEXTURE3D_H__
...
public:
	...
	ComposedTexture3D (X3DExecutionContext* const executionContext);
