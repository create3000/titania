...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING3D_TEXTURE_COORDINATE3D_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING3D_TEXTURE_COORDINATE3D_H__
...
public:
	...
	TextureCoordinate3D (X3DExecutionContext* const executionContext);
