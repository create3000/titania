...
const Component   TextureCoordinate4D::component      = Component ("Texturing3D", 1);
...
void
TextureCoordinate4D::init (MultiTexCoordArray & texCoords) const
{
...
void
TextureCoordinate4D::addTexCoord (const size_t channel, MultiTexCoordArray & texCoords, const size_t index) const
{
	if (index < point () .size ())
...
void
TextureCoordinate4D::erasePoint (const size_t index)
{
	if (index < point () .size ())
