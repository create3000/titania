...
#ifndef __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_WIND_PHYSICS_MODEL_H__
#define __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_WIND_PHYSICS_MODEL_H__
...
public:
	...
	WindPhysicsModel (X3DExecutionContext* const executionContext);
