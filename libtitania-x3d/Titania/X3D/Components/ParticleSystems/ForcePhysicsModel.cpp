...
const ComponentType ForcePhysicsModel::component      = ComponentType::PARTICLE_SYSTEMS;
...
ForcePhysicsModel::ForcePhysicsModel (X3DExecutionContext* const executionContext) :
...
X3DBaseNode*
ForcePhysicsModel::create (X3DExecutionContext* const executionContext) const
{
