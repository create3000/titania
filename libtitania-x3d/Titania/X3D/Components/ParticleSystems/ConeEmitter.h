...
#ifndef __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_CONE_EMITTER_H__
#define __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_CONE_EMITTER_H__
...
public:
	...
	ConeEmitter (X3DExecutionContext* const executionContext);
