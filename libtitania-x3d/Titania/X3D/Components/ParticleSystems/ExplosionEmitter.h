...
#ifndef __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_EXPLOSION_EMITTER_H__
#define __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_EXPLOSION_EMITTER_H__
...
public:
	...
	ExplosionEmitter (X3DExecutionContext* const executionContext);
