...
#ifndef __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_POINT_EMITTER_H__
#define __TITANIA_X3D_COMPONENTS_PARTICLE_SYSTEMS_POINT_EMITTER_H__
...
public:
	...
	PointEmitter (X3DExecutionContext* const executionContext);
