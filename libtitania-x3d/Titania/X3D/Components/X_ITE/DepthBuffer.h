...
#ifndef __TITANIA_X3D_COMPONENTS_X_ITE_DEPTH_BUFFER_H__
#define __TITANIA_X3D_COMPONENTS_X_ITE_DEPTH_BUFFER_H__
...
public:
	...
	DepthBuffer (X3DExecutionContext* const executionContext);
