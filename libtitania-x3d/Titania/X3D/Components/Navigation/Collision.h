...
#ifndef __TITANIA_X3D_COMPONENTS_NAVIGATION_COLLISION_H__
#define __TITANIA_X3D_COMPONENTS_NAVIGATION_COLLISION_H__
...
public:
	...
	Collision (X3DExecutionContext* const executionContext);
