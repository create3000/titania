...
const ComponentType MetadataFloat::component      = ComponentType::CORE;
...
MetadataFloat::MetadataFloat (X3DExecutionContext* const executionContext) :
...
X3DBaseNode*
MetadataFloat::create (X3DExecutionContext* const executionContext) const
{
