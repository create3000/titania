...
const ComponentType MetadataDouble::component      = ComponentType::CORE;
...
MetadataDouble::MetadataDouble (X3DExecutionContext* const executionContext) :
...
X3DBaseNode*
MetadataDouble::create (X3DExecutionContext* const executionContext) const
{
