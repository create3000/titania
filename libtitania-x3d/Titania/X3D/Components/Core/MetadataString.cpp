...
const ComponentType MetadataString::component      = ComponentType::CORE;
const std::string   MetadataString::typeName       = "MetadataString";
const std::string   MetadataString::containerField = "metadata";
...
MetadataString::MetadataString (X3DExecutionContext* const executionContext) :
	...
	X3DMetadataObject (),
	           fields ()
{
	addType (X3DConstants::MetadataString);
...
X3DBaseNode*
MetadataString::create (X3DExecutionContext* const executionContext) const
{
