...
public:
	...
	{
		static_assert (std::is_same_v <Type, std::string> or
		               std::is_same_v <Type, SFBool::internal_type> or
		               std::is_same_v <Type, SFColor::internal_type> or
		               std::is_same_v <Type, SFColorRGBA::internal_type> or
		               std::is_same_v <Type, SFDouble::internal_type> or
		               std::is_same_v <Type, SFFloat::internal_type> or
		               std::is_same_v <Type, SFImage> or
		               std::is_same_v <Type, SFInt32::internal_type> or
							std::is_same_v <Type, SFMatrix3d::internal_type> or
							std::is_same_v <Type, SFMatrix3f::internal_type> or
							std::is_same_v <Type, SFMatrix4d::internal_type> or
							std::is_same_v <Type, SFMatrix4f::internal_type> or
		               std::is_same_v <Type, SFRotation::internal_type>  or
		               std::is_same_v <Type, SFString::internal_type> or
		               std::is_same_v <Type, SFVec2d::internal_type> or
		               std::is_same_v <Type, SFVec2f::internal_type> or
		               std::is_same_v <Type, SFVec3d::internal_type> or
		               std::is_same_v <Type, SFVec3f::internal_type> or
		               std::is_same_v <Type, SFVec4d::internal_type> or
		               std::is_same_v <Type, SFVec4f::internal_type> or
		               std::is_same_v <Type, SFBool> or
		               std::is_same_v <Type, SFColor> or
		               std::is_same_v <Type, SFColorRGBA> or
		               std::is_same_v <Type, SFDouble> or
		               std::is_same_v <Type, SFFloat> or
		               std::is_same_v <Type, SFInt32> or
		               ...
		               std::is_same_v <Type, SFString> or
		               ...
		               std::is_same_v <Type, MFInt32> or
							...
							std::is_same_v <Type, MFMatrix4f> or
							std::is_same_v <Type, MFNode> or
		               std::is_same_v <Type, MFRotation> or
		               std::is_same_v <Type, MFString> or
