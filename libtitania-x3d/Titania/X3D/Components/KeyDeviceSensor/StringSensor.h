...
#ifndef __TITANIA_X3D_COMPONENTS_KEY_DEVICE_SENSOR_STRING_SENSOR_H__
#define __TITANIA_X3D_COMPONENTS_KEY_DEVICE_SENSOR_STRING_SENSOR_H__
...
public:
	...
	StringSensor (X3DExecutionContext* const executionContext);
