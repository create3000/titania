...
#ifndef __TITANIA_X3D_COMPONENTS_PICKING_LINE_PICK_SENSOR_H__
#define __TITANIA_X3D_COMPONENTS_PICKING_LINE_PICK_SENSOR_H__
...
public:
	...
	LinePickSensor (X3DExecutionContext* const executionContext);
