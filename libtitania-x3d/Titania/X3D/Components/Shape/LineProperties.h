...
#ifndef __TITANIA_X3D_COMPONENTS_SHAPE_LINE_PROPERTIES_H__
#define __TITANIA_X3D_COMPONENTS_SHAPE_LINE_PROPERTIES_H__
...
public:
	...
	LineProperties (X3DExecutionContext* const executionContext);
