...
#ifndef __TITANIA_X3D_COMPONENTS_SHAPE_MATERIAL_H__
#define __TITANIA_X3D_COMPONENTS_SHAPE_MATERIAL_H__
...
public:
	...
	Material (X3DExecutionContext* const executionContext);
