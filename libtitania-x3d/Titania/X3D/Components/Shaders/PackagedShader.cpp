...
const Component   PackagedShader::component      = Component ("Shaders", 1);
...
X3DBaseNode*
PackagedShader::create (X3DExecutionContext* const executionContext) const
{
	return new PackagedShader (executionContext);
}

void
PackagedShader::initialize ()
{
