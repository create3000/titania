...
#ifndef __TITANIA_X3D_COMPONENTS_SHADERS_PACKAGED_SHADER_H__
#define __TITANIA_X3D_COMPONENTS_SHADERS_PACKAGED_SHADER_H__
...
public:
	...
	PackagedShader (X3DExecutionContext* const executionContext);
