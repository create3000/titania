...
#ifndef __TITANIA_X3D_COMPONENTS_SHADERS_SHADER_PROGRAM_H__
#define __TITANIA_X3D_COMPONENTS_SHADERS_SHADER_PROGRAM_H__
...
public:
	...
	ShaderProgram (X3DExecutionContext* const executionContext);
