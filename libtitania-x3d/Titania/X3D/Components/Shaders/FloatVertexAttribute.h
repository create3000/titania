...
#ifndef __TITANIA_X3D_COMPONENTS_SHADERS_FLOAT_VERTEX_ATTRIBUTE_H__
#define __TITANIA_X3D_COMPONENTS_SHADERS_FLOAT_VERTEX_ATTRIBUTE_H__
...
public:
	...
	FloatVertexAttribute (X3DExecutionContext* const executionContext);
