...
#ifndef __TITANIA_X3D_COMPONENTS_SHADERS_MATRIX4VERTEX_ATTRIBUTE_H__
#define __TITANIA_X3D_COMPONENTS_SHADERS_MATRIX4VERTEX_ATTRIBUTE_H__
...
public:
	...
	Matrix4VertexAttribute (X3DExecutionContext* const executionContext);
