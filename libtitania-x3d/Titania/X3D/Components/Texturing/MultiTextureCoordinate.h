...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING_MULTI_TEXTURE_COORDINATE_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING_MULTI_TEXTURE_COORDINATE_H__
...
public:
	...
	MultiTextureCoordinate (X3DExecutionContext* const executionContext);
	...
	virtual
	void
	addTexCoord (const size_t, MultiTexCoordArray & texCoords, const size_t) const final override;
