...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING_MULTI_TEXTURE_TRANSFORM_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING_MULTI_TEXTURE_TRANSFORM_H__
...
public:
	...
	MultiTextureTransform (X3DExecutionContext* const executionContext);
