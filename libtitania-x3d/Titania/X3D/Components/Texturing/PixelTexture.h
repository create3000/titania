...
#ifndef __TITANIA_X3D_COMPONENTS_TEXTURING_PIXEL_TEXTURE_H__
#define __TITANIA_X3D_COMPONENTS_TEXTURING_PIXEL_TEXTURE_H__
...
public:
	...
	PixelTexture (X3DExecutionContext* const executionContext);
