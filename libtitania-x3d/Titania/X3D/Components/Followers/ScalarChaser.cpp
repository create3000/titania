...
const Component   ScalarChaser::component      = Component ("Followers", 1);
...
ScalarChaser::ScalarChaser (X3DExecutionContext* const executionContext) :
	...
	previousValue (),
	       buffer ()
{
	addType (X3DConstants::ScalarChaser);
...
ScalarChaser::initialize ()
{
	...
	set_value ()       .addInterest (&ScalarChaser::set_value_, this);
	set_destination () .addInterest (&ScalarChaser::set_destination_, this);
