...
#ifndef __TITANIA_X3D_COMPONENTS_FOLLOWERS_POSITION_CHASER_H__
#define __TITANIA_X3D_COMPONENTS_FOLLOWERS_POSITION_CHASER_H__
...
public:
	...
	PositionChaser (X3DExecutionContext* const executionContext);
