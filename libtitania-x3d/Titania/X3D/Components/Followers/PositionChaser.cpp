...
const ComponentType PositionChaser::component      = ComponentType::FOLLOWERS;
...
PositionChaser::initialize ()
{
	...
	set_value ()       .addInterest (&PositionChaser::set_value_, this);
	set_destination () .addInterest (&PositionChaser::set_destination_, this);
...
bool
PositionChaser::equals (const Vector3f & lhs, const Vector3f & rhs, const float tolerance) const
{
