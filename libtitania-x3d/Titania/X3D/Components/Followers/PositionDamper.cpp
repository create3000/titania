...
const ComponentType PositionDamper::component      = ComponentType::FOLLOWERS;
...
PositionDamper::PositionDamper (X3DExecutionContext* const executionContext) :
	...
	X3DDamperNode (),
	       ...
	       buffer ()
{
	addType (X3DConstants::PositionDamper);
...
PositionDamper::initialize ()
{
	...
	set_value ()       .addInterest (&PositionDamper::set_value_, this);
	set_destination () .addInterest (&PositionDamper::set_destination_, this);
	order ()           .addInterest (&PositionDamper::set_order, this);
...
bool
PositionDamper::equals (const Vector3f & lhs, const Vector3f & rhs, const float tolerance) const
{
...
void
PositionDamper::set_destination_ ()
{
