...
const Component   DISEntityManager::component      = Component ("DIS", 2);
...
X3DBaseNode*
DISEntityManager::create (X3DExecutionContext* const executionContext) const
{
	return new DISEntityManager (executionContext);
}
