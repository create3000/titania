...
#ifndef __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_SEGMENTED_VOLUME_DATA_H__
#define __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_SEGMENTED_VOLUME_DATA_H__
...
public:
	...
	SegmentedVolumeData (X3DExecutionContext* const executionContext);
	...
	MFBool &
	segmentEnabled ()
	{ return *fields .segmentEnabled; }

	virtual
	const MFBool &
	segmentEnabled () const
	{ return *fields .segmentEnabled; }
