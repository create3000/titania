...
#ifndef __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_BOUNDARY_ENHANCEMENT_VOLUME_STYLE_H__
#define __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_BOUNDARY_ENHANCEMENT_VOLUME_STYLE_H__
...
public:
	...
	BoundaryEnhancementVolumeStyle (X3DExecutionContext* const executionContext);
	...
	virtual
	~BoundaryEnhancementVolumeStyle () final override;
