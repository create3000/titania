...
#ifndef __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_VOLUME_DATA_H__
#define __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_VOLUME_DATA_H__
...
public:
	...
	VolumeData (X3DExecutionContext* const executionContext);
