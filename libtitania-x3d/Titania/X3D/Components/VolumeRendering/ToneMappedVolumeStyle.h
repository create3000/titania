...
#ifndef __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_TONE_MAPPED_VOLUME_STYLE_H__
#define __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_TONE_MAPPED_VOLUME_STYLE_H__
...
public:
	...
	ToneMappedVolumeStyle (X3DExecutionContext* const executionContext);
