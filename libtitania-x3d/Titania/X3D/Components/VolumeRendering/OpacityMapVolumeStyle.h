...
#ifndef __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_OPACITY_MAP_VOLUME_STYLE_H__
#define __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_OPACITY_MAP_VOLUME_STYLE_H__
...
public:
	...
	OpacityMapVolumeStyle (X3DExecutionContext* const executionContext);
