...
const Component   ShadedVolumeStyle::component      = Component ("VolumeRendering", 4);
...
ShadedVolumeStyle::getUniformsText () const
{
	...
	string += "\n";
	string += "vec4\n";
	string += "getShadedStyle_" + getStyleId () + " (in vec4 originalColor, in vec3 texCoord)\n";
	string += "{\n";
	...
	if (lighting ())
	{
		if (materialNode)
		{
			...
			string += "\n";
			string += "	shadedColor .a = originalColor .a * (1.0 - transparency_" + getStyleId () + ");\n";
		}
		else
		{
...
ShadedVolumeStyle::getFunctionsText () const
{
	...
	string += "	// ShadedVolumeStyle\n";
	string += "\n";
	string += "	textureColor = getShadedStyle_" + getStyleId () + " (textureColor, texCoord);\n";
