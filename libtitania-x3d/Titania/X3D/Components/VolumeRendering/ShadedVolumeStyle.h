...
#ifndef __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_SHADED_VOLUME_STYLE_H__
#define __TITANIA_X3D_COMPONENTS_VOLUME_RENDERING_SHADED_VOLUME_STYLE_H__
...
public:
	...
	ShadedVolumeStyle (X3DExecutionContext* const executionContext);
	...
	virtual
	~ShadedVolumeStyle () final override;
