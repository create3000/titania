...
#ifndef __TITANIA_X3D_COMPONENTS_ENVIRONMENTAL_SENSOR_PROXIMITY_SENSOR_H__
#define __TITANIA_X3D_COMPONENTS_ENVIRONMENTAL_SENSOR_PROXIMITY_SENSOR_H__
...
public:
	...
	ProximitySensor (X3DExecutionContext* const executionContext);
