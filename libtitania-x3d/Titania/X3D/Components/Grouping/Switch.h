...
#ifndef __TITANIA_X3D_COMPONENTS_GROUPING_SWITCH_H__
#define __TITANIA_X3D_COMPONENTS_GROUPING_SWITCH_H__
...
public:
	...
	Switch (X3DExecutionContext* const executionContext);
