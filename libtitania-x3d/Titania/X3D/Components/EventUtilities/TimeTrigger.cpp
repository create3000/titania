...
const ComponentType TimeTrigger::component      = ComponentType::EVENT_UTILITIES;
...
TimeTrigger::TimeTrigger (X3DExecutionContext* const executionContext) :
	...
	X3DTriggerNode (),
	        fields ()
{
	addType (X3DConstants::TimeTrigger);
...
X3DBaseNode*
TimeTrigger::create (X3DExecutionContext* const executionContext) const
{
...
TimeTrigger::initialize ()
{
	...
	set_boolean () .addInterest (&TimeTrigger::set_boolean_, this);
}
