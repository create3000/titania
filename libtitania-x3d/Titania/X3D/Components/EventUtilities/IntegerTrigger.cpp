...
X3DBaseNode*
IntegerTrigger::create (X3DExecutionContext* const executionContext) const
{
...
IntegerTrigger::initialize ()
{
	...
	set_boolean () .addInterest (&IntegerTrigger::set_boolean_, this);
}
