...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_COORDINATE_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_COORDINATE_INTERPOLATOR_H__
...
public:
	...
	CoordinateInterpolator (X3DExecutionContext* const executionContext);
