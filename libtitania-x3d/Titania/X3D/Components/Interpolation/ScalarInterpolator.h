...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_SCALAR_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_SCALAR_INTERPOLATOR_H__
...
public:
	...
	ScalarInterpolator (X3DExecutionContext* const executionContext);
