...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_COORDINATE_INTERPOLATOR2D_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_COORDINATE_INTERPOLATOR2D_H__
...
public:
	...
	CoordinateInterpolator2D (X3DExecutionContext* const executionContext);
