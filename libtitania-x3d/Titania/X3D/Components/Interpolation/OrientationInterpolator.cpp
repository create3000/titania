...
const Component   OrientationInterpolator::component      = Component ("Interpolation", 1);
...
OrientationInterpolator::interpolate (size_t index0, size_t index1, const float weight)
{
	try
	{
		value_changed () = slerp <double> (keyValue () .get1Value (index0), keyValue () .get1Value (index1), weight);
	}
