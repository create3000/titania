...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_COLOR_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_COLOR_INTERPOLATOR_H__
...
public:
	...
	ColorInterpolator (X3DExecutionContext* const executionContext);
