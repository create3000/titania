...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_NORMAL_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_NORMAL_INTERPOLATOR_H__
...
public:
	...
	NormalInterpolator (X3DExecutionContext* const executionContext);
