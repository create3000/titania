...
public:
	...
	SplinePositionInterpolator2D (X3DExecutionContext* const executionContext);
...
private:
	...
	const std::unique_ptr <math::catmull_rom_spline_interpolator <Vector2f, float>> spline;
