...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_ORIENTATION_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_ORIENTATION_INTERPOLATOR_H__
...
public:
	...
	OrientationInterpolator (X3DExecutionContext* const executionContext);
