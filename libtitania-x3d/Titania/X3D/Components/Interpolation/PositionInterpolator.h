...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_POSITION_INTERPOLATOR_H__
#define __TITANIA_X3D_COMPONENTS_INTERPOLATION_POSITION_INTERPOLATOR_H__
...
public:
	...
	PositionInterpolator (X3DExecutionContext* const executionContext);
