...
const ComponentType ScalarInterpolator::component      = ComponentType::INTERPOLATION;
...
X3DBaseNode*
ScalarInterpolator::create (X3DExecutionContext* const executionContext) const
{
	return new ScalarInterpolator (executionContext);
}

void
ScalarInterpolator::initialize ()
{
...
void
ScalarInterpolator::set_keyValue ()
{
