...
#ifndef __TITANIA_X3D_COMPONENTS_INTERPOLATION_SPLINE_POSITION_INTERPOLATOR_H__
...
public:
	...
	SplinePositionInterpolator (X3DExecutionContext* const executionContext);
...
private:
	...
	const std::unique_ptr <math::catmull_rom_spline_interpolator <Vector3f, float>> spline;
