...
const ComponentType ColorInterpolator::component      = ComponentType::INTERPOLATION;
...
X3DBaseNode*
ColorInterpolator::create (X3DExecutionContext* const executionContext) const
{
	return new ColorInterpolator (executionContext);
}

void
ColorInterpolator::initialize ()
{
