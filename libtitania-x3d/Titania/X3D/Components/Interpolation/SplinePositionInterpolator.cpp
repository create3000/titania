...
const ComponentType SplinePositionInterpolator::component      = ComponentType::INTERPOLATION;
...
SplinePositionInterpolator::SplinePositionInterpolator (X3DExecutionContext* const executionContext) :
	...
	X3DInterpolatorNode (),
	             fields (),
	             spline (new math::catmull_rom_spline_interpolator <Vector3f, float> ())
{
...
SplinePositionInterpolator::initialize ()
{
	...
	normalizeVelocity () .addInterest (&SplinePositionInterpolator::set_normalizeVelocity, this);
}
...
void
SplinePositionInterpolator::set_normalizeVelocity ()
{
