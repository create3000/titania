...
typedef basic::indexed_multimap <std::string, X3DSFNode <ImportedNode>> ImportedNodeArray;

} // X3D

extern template class basic::indexed_multimap <std::string, X3D::X3DSFNode <X3D::ImportedNode>>;
