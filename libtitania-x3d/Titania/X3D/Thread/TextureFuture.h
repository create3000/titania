...
#ifndef __TITANIA_X3D_THREAD_TEXTURE_FUTURE_H__
#define __TITANIA_X3D_THREAD_TEXTURE_FUTURE_H__
...
public:
	...
	using Callback = std::function <void (const basic::uri URL, const TexturePtr & texture)>;
