...
{
	Encode (ostream, value .r (), unitCategory);

	ostream
		<< ','
		<< Generator::TidySpace;

	Encode (ostream, value .g (), unitCategory);

	ostream
		<< ','
		<< Generator::TidySpace;

	Encode (ostream, value .b (), unitCategory);
}
...
JSONGenerator::Encode (std::ostream & ostream, const Color4f & value, const UnitCategory unitCategory)
{
	...
	Encode (ostream, value .a (), unitCategory);
}

void
JSONGenerator::Encode (std::ostream & ostream, const double value, const UnitCategory unitCategory)
{
	if (std::isnan (value) or std::abs (value) == std::numeric_limits <double>::infinity ())
	{
		ostream
			<< '"'
			<< value
...
void
JSONGenerator::Encode (std::ostream & ostream, const float value, const UnitCategory unitCategory)
{
	if (std::isnan (value) or std::abs (value) == std::numeric_limits <float>::infinity ())
	{
		ostream
			<< '"'
			<< value
