...
#ifndef __TITANIA_X3D_BROWSER_NAVIGATION_FLY_VIEWER_H__
#define __TITANIA_X3D_BROWSER_NAVIGATION_FLY_VIEWER_H__
...
public:
	...
	FlyViewer (X3DExecutionContext* const executionContext);
