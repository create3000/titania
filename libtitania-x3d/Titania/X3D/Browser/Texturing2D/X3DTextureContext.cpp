...
X3DTextureContext::X3DTextureContext () :
	            X3DBaseNode (),
	                texture (false),
	          textureMemory (0),
	         minTextureSize (16),
...
X3DTextureContext::initialize ()
{
	if (glXGetCurrentContext ())
	{
		...
		{
			glGetIntegerv (GL_GPU_MEMORY_INFO_DEDICATED_VIDMEM_NVX, &textureMemory);
...
size_t
X3DTextureContext::getAvailableTextureMemory () const
{
