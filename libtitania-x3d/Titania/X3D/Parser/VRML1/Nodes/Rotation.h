...
#ifndef __TITANIA_X3D_PARSER_VRML1_NODES_ROTATION_H__
#define __TITANIA_X3D_PARSER_VRML1_NODES_ROTATION_H__
...
public:
	...
	Rotation (X3D::X3DExecutionContext* const executionContext);
