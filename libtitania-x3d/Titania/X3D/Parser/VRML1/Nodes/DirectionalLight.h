...
#ifndef __TITANIA_X3D_PARSER_VRML1_NODES_DIRECTIONAL_LIGHT_H__
#define __TITANIA_X3D_PARSER_VRML1_NODES_DIRECTIONAL_LIGHT_H__
...
public:
	...
	DirectionalLight (X3D::X3DExecutionContext* const executionContext);
