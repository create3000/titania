...
#ifndef __TITANIA_X3D_PARSER_VRML1_NODES_TRANSLATION_H__
#define __TITANIA_X3D_PARSER_VRML1_NODES_TRANSLATION_H__
...
public:
	...
	Translation (X3D::X3DExecutionContext* const executionContext);
