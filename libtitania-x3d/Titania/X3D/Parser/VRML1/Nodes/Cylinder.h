...
#ifndef __TITANIA_X3D_PARSER_VRML1_NODES_CYLINDER_H__
#define __TITANIA_X3D_PARSER_VRML1_NODES_CYLINDER_H__
...
public:
	...
	Cylinder (X3D::X3DExecutionContext* const executionContext);
