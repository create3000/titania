...
#ifndef __TITANIA_X3D_PARSER_VRML1_NODES_POINT_LIGHT_H__
#define __TITANIA_X3D_PARSER_VRML1_NODES_POINT_LIGHT_H__
...
public:
	...
	PointLight (X3D::X3DExecutionContext* const executionContext);
