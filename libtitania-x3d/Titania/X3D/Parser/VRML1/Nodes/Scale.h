...
#ifndef __TITANIA_X3D_PARSER_VRML1_NODES_SCALE_H__
#define __TITANIA_X3D_PARSER_VRML1_NODES_SCALE_H__
...
public:
	...
	Scale (X3D::X3DExecutionContext* const executionContext);
