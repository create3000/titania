...
#ifndef __TMP_GLAD2CPP_OPEN_LOCATION_DIALOG_H__
#define __TMP_GLAD2CPP_OPEN_LOCATION_DIALOG_H__
...
public:
	...
	template <class ... Arguments>
	X3DOpenLocationDialogInterface (std::initializer_list <std::string> filenames, const Arguments & ... arguments) :
		X3DDialogInterface (arguments ...)
	{ create (filenames); }
