...
#include "X3DWindPhysicsModelEditorInterface.h"

namespace titania {
namespace puck {

void
X3DWindPhysicsModelEditorInterface::create (const std::string & filename)
{
	// Create Builder.
...
void
X3DWindPhysicsModelEditorInterface::create (std::initializer_list <std::string> filenames)
{
	// Create Builder.
...
void
X3DWindPhysicsModelEditorInterface::create ()
{
	// Get objects.
	...
	m_GustinessAdjustment  = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("GustinessAdjustment"));
	m_SpeedAdjustment      = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("SpeedAdjustment"));
	m_TurbulenceAdjustment = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TurbulenceAdjustment"));
	...
	m_builder -> get_widget ("DirectionToolBox", m_DirectionToolBox);
