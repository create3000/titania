...
#include "X3DBackgroundImageEditorInterface.h"

namespace titania {
namespace puck {

void
X3DBackgroundImageEditorInterface::create (const std::string & filename)
{
	// Create Builder.
...
void
X3DBackgroundImageEditorInterface::create (std::initializer_list <std::string> filenames)
{
	// Create Builder.
...
X3DBackgroundImageEditorInterface::create ()
{
	...
	m_builder -> get_widget ("ImageChooserButton", m_ImageChooserButton);
	...
	// Connect object Gtk::Button with id 'ImageReloadButton'.
	m_ImageReloadButton -> signal_clicked () .connect (sigc::mem_fun (this, &X3DBackgroundImageEditorInterface::on_image_reload_clicked));
	m_ImageRemoveButton -> signal_clicked () .connect (sigc::mem_fun (this, &X3DBackgroundImageEditorInterface::on_image_remove_clicked));
}

X3DBackgroundImageEditorInterface::~X3DBackgroundImageEditorInterface ()
{
	delete m_Window;
}
