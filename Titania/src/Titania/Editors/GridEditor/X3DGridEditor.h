...
#ifndef __TITANIA_EDITORS_GRID_EDITOR_X3DGRID_EDITOR_H__
#define __TITANIA_EDITORS_GRID_EDITOR_X3DGRID_EDITOR_H__
...
private:
	...
	virtual
	void
	on_add_major_line_grid () final override;
	
	virtual
	void
	on_remove_major_line_grid () final override;
