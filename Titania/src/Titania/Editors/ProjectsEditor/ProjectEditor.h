...
#ifndef __TITANIA_EDITORS_PROJECTS_EDITOR_PROJECT_EDITOR_H__
#define __TITANIA_EDITORS_PROJECTS_EDITOR_PROJECT_EDITOR_H__

#include "../../UserInterfaces/X3DProjectEditorInterface.h"
...
class ProjectEditor :
	virtual public X3DProjectEditorInterface,
	public X3DFileBrowser <X3DProjectEditorInterface>
{
public:

	///  @name Construction

	ProjectEditor (X3DBrowserWindow* const browserWindow, const basic::uri & folder);

	///  @name Destruction

	virtual
	~ProjectEditor () final override;
