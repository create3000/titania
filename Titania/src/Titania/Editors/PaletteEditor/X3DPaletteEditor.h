...
{
	const auto shape      = preview -> getExecutionContext () -> template createNode <X3D::Shape> ();
	const auto appearance = preview -> getExecutionContext () -> template createNode <X3D::Appearance> ();
	const auto material   = preview -> getExecutionContext () -> template createNode <X3D::Material> ();
	const auto box        = preview -> getExecutionContext () -> template createNode <X3D::Box> ();
