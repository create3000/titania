...
#ifndef __TITANIA_EDITORS_GEOMETRY_PROPERTIES_EDITOR_NURBS_X3DNURBS_PATCH_SURFACE_EDITOR_H__
#define __TITANIA_EDITORS_GEOMETRY_PROPERTIES_EDITOR_NURBS_X3DNURBS_PATCH_SURFACE_EDITOR_H__
...
class X3DNurbsPatchSurfaceEditor :
...
public:
	...
	virtual
	~X3DNurbsPatchSurfaceEditor () override;
