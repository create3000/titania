...
#ifndef __TITANIA_EDITORS_GRID_EDITOR_X3DANGLE_EDITOR_H__
#define __TITANIA_EDITORS_GRID_EDITOR_X3DANGLE_EDITOR_H__
...
private:
	...
	virtual
	void
	on_angle_toggled () final override;

	virtual
	void
	on_angle_plane_changed () final override;
