...
GridTool::fromMetadata ()
{
	...
	getTool () -> dimension ()       = getMetaData (getCurrentBrowser (), "/Titania/" + getName () + "/dimension",       X3D::MFInt32 ({ 10, 10, 10 }));
	getTool () -> majorLineEvery ()  = getMetaData (getCurrentBrowser (), "/Titania/" + getName () + "/majorLineEvery",  X3D::MFInt32 ({ 5, 5, 5 }));
