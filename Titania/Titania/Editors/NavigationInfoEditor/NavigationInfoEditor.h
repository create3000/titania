...
#ifndef __TITANIA_EDITORS_NAVIGATION_INFO_EDITOR_NAVIGATION_INFO_EDITOR_H__
#define __TITANIA_EDITORS_NAVIGATION_INFO_EDITOR_NAVIGATION_INFO_EDITOR_H__
...
class NavigationInfoEditor :
	virtual public X3DNavigationInfoEditorInterface
{
public:
