...
#include "../../UserInterfaces/X3DPrototypeInstanceDialogInterface.h"

namespace titania {
namespace puck {

class PrototypeInstanceDialog :
	virtual public X3DPrototypeInstanceDialogInterface
{
public:
