...
#ifndef __TITANIA_EDITORS_GEOMETRY_PROPERTIES_EDITOR_GEOMETRY3D_X3DCYLINDER_EDITOR_H__
#define __TITANIA_EDITORS_GEOMETRY_PROPERTIES_EDITOR_GEOMETRY3D_X3DCYLINDER_EDITOR_H__
...
private:
	...
	void
	set_node (const X3D::X3DPtr <X3D::Cylinder> &);
