...
#ifndef __TITANIA_EDITORS_GEOMETRY_PROPERTIES_EDITOR_GEOMETRY2D_X3DRECTANGLE2DEDITOR_H__
#define __TITANIA_EDITORS_GEOMETRY_PROPERTIES_EDITOR_GEOMETRY2D_X3DRECTANGLE2DEDITOR_H__
...
private:
	...
	void
	set_node (const X3D::X3DPtr <X3D::Rectangle2D> &);
