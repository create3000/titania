...
#ifndef __TITANIA_EDITORS_HISTORY_EDITOR_HISTORY_EDITOR_H__
#define __TITANIA_EDITORS_HISTORY_EDITOR_HISTORY_EDITOR_H__
...
public:
	...
	HistoryEditor (X3DBrowserWindow* const browserWindow);

	///  @name Destruction

	virtual
	~HistoryEditor () final override;
