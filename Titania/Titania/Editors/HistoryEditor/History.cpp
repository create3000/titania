	   ...
	   fileMonitor ()
{
	try
	{
		...
		if (not have_history)
		{
			setItem ("Gears",                 "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Gears/gears.x3d",  "");
			setItem ("Schacht",               "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Schacht/index.wrl",  "");
			setItem ("Appartment",            "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Appartment/index.wrl",  "");
			setItem ("LogoPieces",            "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/LogoPieces/index.x3d",  "");
	
			setItem ("Anatomy",               "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Compel/anatomy/anatomy.wrl",  "");
			setItem ("MovieTruck",            "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/MovieTruck/stage/index.wrl",  "");
			setItem ("ICTS",                  "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/ICTS/index.wrl",  "");
			setItem ("Dolphin",               "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Dolphin/index.wrl",  "");
			setItem ("BIC Info",              "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/BIC/info.wrl",  "");
			setItem ("BIC Buero",             "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/BIC/buero.wrl",  "");
			setItem ("BIC Building",          "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/BIC/building.wrl",  "");
			setItem ("BIC Man",               "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/BIC/index.wrl",  "");
			setItem ("Jungle",                "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Compel/jungle/jungle.wrl",  "");
			setItem ("Ripple",                "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Compel/ripple.wrl",  "");
			setItem ("VRML Banner",           "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/VRMLBanner/vrmlbanner.wrl",  "");
			setItem ("NIST-Logo",             "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/NIST-Logo/index.wrl",  "");
	
			setItem ("Magic Mushrooms",       "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Mushrooms/index.wrl",  "");
			setItem ("Old Leipzig Rathaus",   "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Rathaus/stage/index.x3d",  "");
			setItem ("Terrain",               "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Terrain/index.wrl",  "");
			setItem ("Approach",              "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Approach/stage/index.wrl",  "");
			setItem ("Huey Huey",             "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Compel/huey.wrl",  "");
			setItem ("Lost Cathedral",        "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Cathedral/stage/index.wrl",  "");
			setItem ("Lust For Life",         "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/LustForLife/stage/index.wrl",  "");
			setItem ("Mediafacade Berlin",    "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Vattenfall/index.wrl",  "");
			setItem ("Foldup",                "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Compel/foldup.wrl",  "");
			setItem ("4 Pong",                "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Pong/index.wrl",  "");
			setItem ("Arcadia",               "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Arcadia/stage/index.wrl",  "");
			setItem ("Astronomy",             "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Astronomy/stage/astrnmy.wrl",  "");
			setItem ("Backyard Soccer",       "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/ICTS/soccer.wrl",  "");
			setItem ("The Secret Labyrinth",  "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/ICTS/labyrinth.wrl",  "");
			setItem ("Smashing Boxes",        "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Boxes/boxes.x3d",  "");
			setItem ("Chomp!",                "https://cdn.rawgit.com/create3000/Library/1.0.2/Examples/Chomp/chomp.x3d",  "");
