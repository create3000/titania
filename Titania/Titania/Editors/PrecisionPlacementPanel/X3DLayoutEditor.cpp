...
X3DLayoutEditor::X3DLayoutEditor () :
	X3DPrecisionPlacementPanelInterface (),
	                       ...
	                       layoutBuffer (),
	                           ...
	                           undoStep (),
	                           changing (false),
	                             alignX (getBrowserWindow (), getLayoutAlignXComboBoxText (), "align", 0, "CENTER"),
	                             alignY (getBrowserWindow (), getLayoutAlignYComboBoxText (), "align", 1, "CENTER"),
	                       offsetUnitsX (getBrowserWindow (), getLayoutOffsetUnitsXComboBoxText (), "offsetUnits", 0, "WORLD"),
	                       offsetUnitsY (getBrowserWindow (), getLayoutOffsetUnitsYComboBoxText (), "offsetUnits", 1, "WORLD"),
	                             offset (getBrowserWindow (),
	                                     getLayoutOffsetXAdjustment (),
	                                     getLayoutOffsetYAdjustment (),
	                                     getLayoutOffsetBox (),
	                                     "offset"),
	                         sizeUnitsX (getBrowserWindow (), getLayoutSizeUnitsXComboBoxText (), "sizeUnits", 0, "WORLD"),
	                         sizeUnitsY (getBrowserWindow (), getLayoutSizeUnitsYComboBoxText (), "sizeUnits", 1, "WORLD"),
	                               size (getBrowserWindow (),
	                                     getLayoutSizeXAdjustment (),
	                                     getLayoutSizeYAdjustment (),
	                                     getLayoutSizeBox (),
	                                     "size"),
	                         scaleModeX (getBrowserWindow (), getLayoutScaleModeXComboBoxText (), "scaleMode", 0, "NONE"),
	                         scaleModeY (getBrowserWindow (), getLayoutScaleModeYComboBoxText (), "scaleMode", 1, "NONE")
{
