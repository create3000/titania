...
#include "X3DPolylineEmitterEditor.h"
...
X3DPolylineEmitterEditor::X3DPolylineEmitterEditor () :
	X3DPrecisionPlacementPanelInterface (),
	                          direction (this,
	                                     getPolylineEmitterDirectionXAdjustment (),
	                                     getPolylineEmitterDirectionYAdjustment (),
