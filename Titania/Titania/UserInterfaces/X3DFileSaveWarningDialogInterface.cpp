...
#include "X3DFileSaveWarningDialogInterface.h"
...
void
X3DFileSaveWarningDialogInterface::create (std::initializer_list <std::string> filenames)
{
	// Create Builder.
...
void
X3DFileSaveWarningDialogInterface::create ()
{
	// Get objects.
