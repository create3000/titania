...
public:
	...
	Gtk::Box &
	getNodePropertiesBox () const
	{ return *m_NodePropertiesBox; }

	Gtk::Box &
	getNodeFieldsBox () const
	{ return *m_NodeFieldsBox; }
	...
	Gtk::Box &
	getTexturesBox () const
	{ return *m_TexturesBox; }
...
private:
	...
	Gtk::Window*                           m_Window;
	Gtk::Box*                              m_Widget;
	Gtk::Box*                              m_NodePropertiesBox;
	Gtk::Box*                              m_NodeFieldsBox;
	Gtk::Box*                              m_Widget1;
	Gtk::Box*                              m_ActionBox;
