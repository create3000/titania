...
X3DInlineEditorInterface::create (const std::string & filename)
{
	...
	m_connections .emplace_back (m_NewInlineButton -> signal_clicked () .connect (sigc::mem_fun (*this, &X3DInlineEditorInterface::on_new_inline_clicked)));
	m_connections .emplace_back (m_RemoveInlineButton -> signal_clicked () .connect (sigc::mem_fun (*this, &X3DInlineEditorInterface::on_remove_inline_clicked)));
	m_connections .emplace_back (m_IndexButton -> signal_clicked () .connect (sigc::mem_fun (*this, &X3DInlineEditorInterface::on_index_clicked)));
	m_connections .emplace_back (m_ConvertMasterSelectionButton -> signal_clicked () .connect (sigc::mem_fun (*this, &X3DInlineEditorInterface::on_convert_master_selection_clicked)));
	m_connections .emplace_back (m_FoldBackIntoSceneButton -> signal_clicked () .connect (sigc::mem_fun (*this, &X3DInlineEditorInterface::on_fold_back_into_scene_clicked)));
