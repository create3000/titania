...
X3DPrecisionPlacementPanelInterface::create (const std::string & filename)
{
	...
	m_FillBoundingBoxFieldsButton -> set_name ("FillBoundingBoxFieldsButton");
