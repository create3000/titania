...
X3DPrecisionPlacementPanelInterface::create ()
{
	...
	m_TextureProjectorParallelAspectRatioAdjustment     = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelAspectRatioAdjustment"));
	m_TextureProjectorParallelDescriptionTextBuffer     = Glib::RefPtr <Gtk::TextBuffer>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelDescriptionTextBuffer"));
	m_TextureProjectorParallelDirectionXAdjustment      = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelDirectionXAdjustment"));
	m_TextureProjectorParallelDirectionYAdjustment      = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelDirectionYAdjustment"));
	m_TextureProjectorParallelDirectionZAdjustment      = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelDirectionZAdjustment"));
	m_TextureProjectorParallelFarDistanceAdjustment     = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelFarDistanceAdjustment"));
	m_TextureProjectorParallelFieldOfViewMaxXAdjustment = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelFieldOfViewMaxXAdjustment"));
	m_TextureProjectorParallelFieldOfViewMaxYAdjustment = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelFieldOfViewMaxYAdjustment"));
	m_TextureProjectorParallelFieldOfViewMinXAdjustment = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelFieldOfViewMinXAdjustment"));
	m_TextureProjectorParallelFieldOfViewMinYAdjustment = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelFieldOfViewMinYAdjustment"));
	m_TextureProjectorParallelLocationXAdjustment       = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelLocationXAdjustment"));
	m_TextureProjectorParallelLocationYAdjustment       = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelLocationYAdjustment"));
	m_TextureProjectorParallelLocationZAdjustment       = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelLocationZAdjustment"));
	m_TextureProjectorParallelNearDistanceAdjustment    = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelNearDistanceAdjustment"));
	m_TextureProjectorParallelUpVectorXAdjustment       = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelUpVectorXAdjustment"));
	m_TextureProjectorParallelUpVectorYAdjustment       = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelUpVectorYAdjustment"));
	m_TextureProjectorParallelUpVectorZAdjustment       = Glib::RefPtr <Gtk::Adjustment>::cast_dynamic (m_builder -> get_object ("TextureProjectorParallelUpVectorZAdjustment"));
	...
	m_builder -> get_widget ("TextureProjectorParallelExpander", m_TextureProjectorParallelExpander);
	m_builder -> get_widget ("TextureProjectorParallelOnCheckButton", m_TextureProjectorParallelOnCheckButton);
	m_builder -> get_widget ("TextureProjectorParallelDescriptionTextView", m_TextureProjectorParallelDescriptionTextView);
	m_builder -> get_widget ("TextureProjectorParallelGlobalCheckButton", m_TextureProjectorParallelGlobalCheckButton);
	m_builder -> get_widget ("TextureProjectorParallelLocationBox", m_TextureProjectorParallelLocationBox);
	m_builder -> get_widget ("TextureProjectorParallelLocationXSpinButton", m_TextureProjectorParallelLocationXSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelLocationYSpinButton", m_TextureProjectorParallelLocationYSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelLocationZSpinButton", m_TextureProjectorParallelLocationZSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelDirectionToolBox", m_TextureProjectorParallelDirectionToolBox);
	m_builder -> get_widget ("TextureProjectorParallelDirectionBox", m_TextureProjectorParallelDirectionBox);
	m_builder -> get_widget ("TextureProjectorParallelDirectionXSpinButton", m_TextureProjectorParallelDirectionXSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelDirectionYSpinButton", m_TextureProjectorParallelDirectionYSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelDirectionZSpinButton", m_TextureProjectorParallelDirectionZSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelUpVectorToolBox", m_TextureProjectorParallelUpVectorToolBox);
	m_builder -> get_widget ("TextureProjectorParallelUpVectorBox", m_TextureProjectorParallelUpVectorBox);
	m_builder -> get_widget ("TextureProjectorParallelUpVectorXSpinButton", m_TextureProjectorParallelUpVectorXSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelUpVectorYSpinButton", m_TextureProjectorParallelUpVectorYSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelUpVectorZSpinButton", m_TextureProjectorParallelUpVectorZSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelNearDistanceSpinButton", m_TextureProjectorParallelNearDistanceSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelFarDistanceSpinButton", m_TextureProjectorParallelFarDistanceSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelAspectRatioSpinButton", m_TextureProjectorParallelAspectRatioSpinButton);
	m_builder -> get_widget ("TextureProjectorParallelFieldOfViewBox", m_TextureProjectorParallelFieldOfViewBox);
	m_builder -> get_widget ("TextureProjectorParallelFieldOfViewSpinButton3", m_TextureProjectorParallelFieldOfViewSpinButton3);
	m_builder -> get_widget ("TextureProjectorParallelFieldOfViewSpinButton0", m_TextureProjectorParallelFieldOfViewSpinButton0);
	m_builder -> get_widget ("TextureProjectorParallelFieldOfViewSpinButton2", m_TextureProjectorParallelFieldOfViewSpinButton2);
	m_builder -> get_widget ("TextureProjectorParallelFieldOfViewSpinButton1", m_TextureProjectorParallelFieldOfViewSpinButton1);
