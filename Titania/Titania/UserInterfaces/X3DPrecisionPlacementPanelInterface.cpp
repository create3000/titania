...
X3DPrecisionPlacementPanelInterface::create ()
{
	...
	m_builder -> get_widget ("PointEmitterNormalToolBox", m_PointEmitterNormalToolBox);
	...
	m_builder -> get_widget ("ConeEmitterNormalToolBox", m_ConeEmitterNormalToolBox);
	...
	m_builder -> get_widget ("PolylineEmitterNormalToolBox", m_PolylineEmitterNormalToolBox);
	...
	m_builder -> get_widget ("VolumeEmitterNormalToolBox", m_VolumeEmitterNormalToolBox);
