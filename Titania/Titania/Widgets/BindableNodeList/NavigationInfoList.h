...
#ifndef __TITANIA_WIDGETS_BINDABLE_NODE_LIST_NAVIGATION_INFO_LIST_H__
#define __TITANIA_WIDGETS_BINDABLE_NODE_LIST_NAVIGATION_INFO_LIST_H__
...
using NavigationInfoList = X3DBindableNodeList <X3D::NavigationInfo>;
