...
#include <Titania/External/ApproxMVBB/Common/LogDefines.hpp>
...
#include <Titania/External/ApproxMVBB/GreatestCommonDivisor.hpp>
#include <Titania/External/ApproxMVBB/RandomGenerators.hpp>
#include <Titania/External/ApproxMVBB/ProjectedPointSet.hpp>
                               ...
                               )
{
    ...
    // Define the volume lower bound above we accept a new volume as
    //PREC volumeAcceptTol = oobb.volume() * volumeAcceptFactor; // not used
