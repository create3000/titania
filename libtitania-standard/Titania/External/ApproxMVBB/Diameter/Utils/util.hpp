...
#include <Titania/External/ApproxMVBB/Diameter/TypeSegment.hpp>
#include <Titania/External/ApproxMVBB/Diameter/Utils/alloc.hpp>
...
namespace Diameter{
    ...
    */
    ...
    APPROXMVBB_EXPORT int _FindPointInList( double const**theList,
              const int first,
              const int last,
              double x0,
              double x1 );
