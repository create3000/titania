...
//
template std::istream & operator >> (std::istream &, quaternion <float> &);
template std::istream & operator >> (std::istream &, quaternion <double> &);
template std::istream & operator >> (std::istream &, quaternion <long double> &);
