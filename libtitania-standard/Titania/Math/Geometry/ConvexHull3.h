	  ...
	  m_indices ()
{
	...
	while (not faces_stack .empty ())
	{
		...
		// Get most distant point of the face°Øs point-set.
		...
		// Each point is assigned to the first face it can see. I tried different assigning priorities, but it didn°Øt help
