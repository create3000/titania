...
#ifndef __TITANIA_OS_SYSTEM_H__
#define __TITANIA_OS_SYSTEM_H__
...
inline
void
join_command (std::string & buffer)
{ }

template <typename ... Args>
void
join_command (std::string & buffer, const std::string argument, const Args & ... args)
{
	buffer += ' ' + escape_argument (argument);
