...
OutlineTreeView::OutlineTreeView (const X3D::SFNode <X3D::X3DBrowser> & browser) :
	Gtk::TreeView (),
	X3DBaseInterface ()
{
	setBrowser (browser);
	...
	getBrowser () -> world .addInterest (this, &OutlineTreeView::set_scene);
}

void
OutlineTreeView::set_scene ()
{
