/*
 * http://koders.com/cpp/fid38F83F165ABF728D6046FD59CF21ECF65E30E2D4.aspx?s=matrix#L117
 *
...
//! @brief Constructor.
{
	if (axis .Nrows () not_eq 3)
	{
		cerr << "Quaternion::Quaternion, size of axis not_eq 3" << endl;
		exit (1);
	}
...
void
Quaternion::set_v (const ColumnVector & v)
...
ReturnMatrix
Quaternion::E (const short sign) const
/*!
 * @brief Matrix E.
 *
...
Real
Quaternion::dot_prod (const Quaternion & q) const
/*!
...
ReturnMatrix
Omega (const Quaternion & q, const Quaternion & q_dot)
/*!
...
short
Integ_quat (Quaternion & dquat_present, Quaternion & dquat_past,
...
Real
Integ_Trap_quat_s (const Quaternion & present, Quaternion & past,
                   const Real dt)
...
ReturnMatrix
Integ_Trap_quat_v (const Quaternion & present, Quaternion & past,
                   const Real dt)
...
Quaternion
Slerp (const Quaternion & q0, const Quaternion & q1, const Real t)
/*!
...
Quaternion
Slerp_prime (const Quaternion & q0, const Quaternion & q1,
             const Real t)
/*!
...
Quaternion
Squad (const Quaternion & p, const Quaternion & a, const Quaternion & b,
...
Quaternion
Squad_prime (const Quaternion & p, const Quaternion & a, const Quaternion & b,
             const Quaternion & q, const Real t)
/*!
